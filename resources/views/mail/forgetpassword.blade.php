...
<head>
    ...
    <title>Exam Centre London | Forget Password</title>
    <style>
...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <p>Thank you for requesting  <strong>a password reset with Exam Centre London.</strong>Your verification code is:</p>
            
            <h3 style="text-align: center; color: #004080; border:1px solid">{{ $code }}</h3>

            <p>Please Enter the verification code and update your password.If you did not request a password reset, please ignore this email. For your security, no changes have been made to your account.</p>
