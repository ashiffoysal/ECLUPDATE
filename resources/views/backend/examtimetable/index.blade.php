        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Exam TimeTables Manage</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder fs-3 mb-1">All Subject</span> <br>
                                <a href="{{ url('admin/exam-timetables/create') }}" class="btn btn-success"> Create Exam Timetables</a>
                        ...
                        <div class="card-body py-3">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="dataTableExample1" class="data-table" style="width:100%;font-size:14px" >
                                    ...
                                    <th class="">#</th>
                                    <th class="min-w-140px">Exam Series</th>
                                    ...
                                    @foreach($alldata as $key => $data)
                                        <tr>
                                            <td> {{ ++$key }} </td>
                                               <td>
                                                   @php
                                                   $series=DB::table('examessuedates')->where('id',$data->exam_series)->select(['exam_name'])->first();
                                                   @endphp
                                                 {{ $series->exam_name }}
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-end">
                                                ...
                                                @if($data->is_active==1)
                                                  <a href="{{url('/admin/exam-timetables/deactive/'.$data->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                <i class="fa fa-thumbs-up blue"></i>
                                                </a>
                                                @else
                                                     <a href="{{url('/admin/exam-timetables/active/'.$data->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                <i class="fa fa-thumbs-down blue"></i>
                                                @endif
                                               
                                               
                                                <a href="{{url('/admin/exam-timetables/edit/'.$data->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                <i class="fa fa-edit blue"></i>
                                                </a>
                                                <a id="delete" href="{{url('/admin/exam-timetables/delete/'.$data->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
