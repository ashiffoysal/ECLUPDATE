    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Exam TimeTables Update</h1>
                <!--end::Title-->
            </div>
        ...
        <div id="kt_content_container" class="container-fluid">
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Update Exams TimeTables</p>
                           <a href="{{ url('admin/exam-timetables/index') }}" class="btn btn-success"> All Exam Timetables</a>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
            <div class="card">
                <form action="{{ url('admin/exam-timetables/update') }}" method="post" enctype="multipart/form-data">
                    @csrf
                        <!-- radio ends -->
                    <div class="row">
                                    ...
                                    <div class="tab-pane active" id="kt_builder_main" data-select2-id="select2-data-kt_builder_main">
                                         <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                   ...
                                                   <select name="exam_series" class="form-select form-select-solid" >
                                                       @foreach($examseries as $exams)
                                                       <option value="{{$exams->id}}" @if($exams->id==$data->exam_series) selected @endif>{{$exams->exam_name}}</option>
                                                   @endforeach 
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                   <select name="exam_type" class="form-select form-select-solid" >
                                                       <option value="GCSE" @if($data->exam_type=='GCSE') selected @endif>GCSE</option>
                                                       <option value="A Level"  @if($data->exam_type=='A Level') selected @endif>A Level</option>
                                                        <option value="AS Level"  @if($data->exam_type=='AS Level') selected @endif>AS Level</option>
                                                       <option value="IGCSE"  @if($data->exam_type=='IGCSE') selected @endif>IGCSE</option>
                                         ...
                                         <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                   <select name="exam_board" class="form-select form-select-solid" >
                                                       <option value="none" @if($data->exam_board=='none') selected @endif>None</option>
                                                       <option value="Edexcel" @if($data->exam_board=='Edexcel') selected @endif>Edexcel</option>
                                                       <option value="AQA" @if($data->exam_board=='AQA') selected @endif>AQA</option>
                                                       <option value="OCR" @if($data->exam_board=='OCR') selected @endif>OCR</option>
                                                       <option value="Cambridge CIE" @if($data->exam_board=='Cambridge CIE') selected @endif>Cambridge(CIE)</option>
                                                       <option value="WJEC" @if($data->exam_board=='WJEC') selected @endif>WJEC</option>
                                          ...
                                          <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">TimeTables PDF:<span class="required"></span></label>
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="file" name="filepdf"  placeholder="Enter High Late Fees">
                                                </div>
