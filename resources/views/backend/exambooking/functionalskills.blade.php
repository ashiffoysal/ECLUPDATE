...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-muted">Functional Skills</li>
										<!--end::Item-->
						...
						<div class="post d-flex flex-column-fluid" id="kt_post">
							...
							<div id="kt_content_container" class="container">
								<!--begin::Card-->
								<form action="{{ url('admin/exam-booking-functionalskills/create') }}" method="post"  enctype="multipart/form-data">
									@csrf
								<div class="card">
					                        ...
					                        <div class="row">
				                                ...
				                                <div class="col-lg-12">
				                                    <label for="middle_name" class="form-label">Exam Type</label>
				                               		<input type="hidden" name="main_exam_type" value="Functional Skills">
				                               		<input type="text" class="form-control form-control-lg form-control-solid" disabled value="Functional Skills" />
				                                </div>
                                ...
                                <div class="col-md-3" style="margin: 0px 5px;">
                                        ...
                                        <div class="mb-0 fv-row">
                                          ...
                                          <input type="date" name="exam_date[]" class="form-control form-control-lg form-control-solid exam_date">
