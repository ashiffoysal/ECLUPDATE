...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-muted">IGCSE</li>
										<!--end::Item-->
						...
						<div class="post d-flex flex-column-fluid" id="kt_post">
							...
							<div id="kt_content_container" class="container">
								<!--begin::Card-->
								<form action="{{ url('admin/exam-booking-igcse/create') }}" method="post"  enctype="multipart/form-data">
									@csrf
								<div class="card">
					                        ...
					                        <div class="row">
				                                ...
				                                <div class="col-lg-12">
				                                    <label for="middle_name" class="form-label">Exam Type</label>
				                               		<input type="hidden" name="main_exam_type" value="IGCSE">
				                               		<input type="text" class="form-control form-control-lg form-control-solid" disabled value="IGCSE" />
				                                </div>
                                ...
                                <!--  -->
                                <div class="col-lg-12 mt-2" id="has_a_candidate_section" > 
                                  ...
                                  <span>This will be on Previous Timetables and Results Information</span>
                                    <input type="text" name="has_a_candidate_number" id="has_a_candidate_number" class="form-control form-control-lg form-control-solid" aria-describedby="passwordHelpBlock" value="" max="4">
                                ...
                                <div class="col-lg-12 mt-2">
                                  ...
                                  <div class="form-check" style="margin:10px 0px">
                                    <input  onchange="insertmybooking()"  class="form-check-input uci" id="no" type="radio" checked="checked" name="uci" value="no"/>
                                ...
                                <div class="col-lg-12 mt-2" id="uci_section" >
                                  <label for="UCI" class="form-label">UCI Number ( 13 digits )</label>
                                    <input type="text"  name="uci_number" class="form-control form-control-lg form-control-solid uci_number" aria-describedby="passwordHelpBlock" value="">
                                 ...
                                 <div class="col-lg-12 mt-2" id="uln_section">
                                  <label for="UCI" class="form-label">ULN Number ( 10 digits )</label>
                                    <input type="text" max="10" name="uln_number" id="uln" class="form-control form-control-lg form-control-solid uln_number" aria-describedby="passwordHelpBlock">
                                ...
                                <div class="col-md-2">
                                 ...
                                 <div class="col-md-2">
                                   ...
                                   <select name="subject[]"  id="subject_0"  class="form-select form-select-lg form-select-solid subject">
...
<script>
  ...
  <script>
    function typecheange(el){
          ...
          if(type_id) {
             $.ajax({
                 url: "{{  url('/get/admin-igcse/subject/all/') }}/"+type_id,
                 type:"GET",
                 dataType:"json",
