...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Topics Create</h1>
                <!--end::Title-->
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card">
                <form action="{{ url('admin/exam-all-topic/create') }}" method="post" enctype="multipart/form-data">
                    @csrf
                        <!-- radio ends -->
                    <div class="row">
                                         ...
                                         <div class="row mb-10">
                                            ...
                                            <div class="col-md-9 ">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text" name="title" placeholder="Enter Title" value="{{ old('title') }}" required>
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <div class="d-flex fw-bold h-100">
                                                  <textarea class="form-control form-control-solid" id="summernote" name="notes" rows="20" cols="50" required placeholder="Enter Notes" ></textarea>
                                                </div>
                                                <!--end::Wrapper-->
                                            </div>
                                        </div>
