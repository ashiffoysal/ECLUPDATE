...
<!-- <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/jQuery.print/1.6.2/jQuery.print.min.js"> -->
			...
			<div class="toolbar" id="kt_toolbar">
				...
				<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
					...
					<div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
						<!--begin::Title-->
						<h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Candidate Support </h1>
						...
						<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
							...
							<li class="breadcrumb-item text-muted">
								<a href="index.html" class="text-muted text-hover-primary">Support Details</a>
							</li>
							<!--end::Item-->
							<!--begin::Item-->
							...
							<!--end::Item-->
							<!--begin::Item-->
							<li class="breadcrumb-item text-muted">Candidate Support Details</li>
							<!--end::Item-->
							...
							<div class="d-flex flex-column flex-xl-row" id="printableArea">
								...
								<div class="flex-lg-row-fluid me-xl-18 mb-10 mb-xl-0">
									...
									<div class="mt-n1">
										...
										<div class="m-0">
											<!--begin::Label-->
											<div class="fw-bolder fs-3 text-gray-800 mb-8">Support-ID #{{$data->support_id}}</div>
											<!--end::Label-->
											<!--begin::Row-->
											<div class="row g-5 mb-2">
												...
												<div class="col-sm-6">
													...
													<!--end::Label-->
													<!--end::Col-->
													<div class="fw-bolder fs-6 text-gray-800">@php
											...
											<div class="row g-5 mb-2">
												...
												<div class="col-sm-6">
													<!--end::Label-->
													<div class="fw-bold fs-7 text-gray-600 mb-1">Supports For:</div>
													<!--end::Label-->
													<!--end::Text-->
													<div class="fw-bolder fs-6 text-gray-800">{{$data->name}}</div>
													<!--end::Text-->
													<!--end::Description-->
													<div class="fw-bold fs-7 text-gray-600">{{$data->phone}}
													<br />{{$data->email}}
												</div>
													<!--end::Description-->
												</div>
												...
												<div class="col-sm-6">
													<!--end::Label-->
													<div class="fw-bold fs-7 text-gray-600 mb-1">Supports By:</div>
													<!--end::Label-->
													<!--end::Text-->
											...
											<div class="flex-grow-1">
												...
												@if($data->inquery_exams==1)
													...
													<table class="table mb-3">
													    @if($data->inquery_supports==1)
														<tbody>
														    <tr>
														        <td><span style="font-weight:blod">Special Access:</span>			{{ $data->special_access }}</td>
														    </tr>
														</tbody>
														@endif
														...
														<tbody>
														    <tr>
														        <td><span style="font-weight:blod">Notes:</span> {!! $data->notes !!}</td>
														    </tr>
														</tbody>
								...
								<div class="m-0">
									...
									<div class="border border-dashed border-gray-300 card-rounded h-lg-100 min-w-md-350px p-9 bg-lighten">
										...
										<!--end::Labels-->
										<!--begin::Title-->
										<h6 class="mb-2 text-hover-primary">Creation Details</h6>
										<!--end::Title-->
										<!--begin::Item-->
										<div class="mb-2">
										...
										<div class="mb-6">
											...
											<div class="fw-bolder text-gray-800 fs-6">{{ $data->createdby }} </div>
										</div>
										<!--end::Item-->
										<!--begin::Item-->
										<!-- <div class="m-0">
