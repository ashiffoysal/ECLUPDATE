            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <div class="ms-6">
                     ...
                     <div class="ms-6">
                        <a href="{{url('admin/exam-all-topic/create')}}" class="badge badge-danger">Add Topics</a>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                                    ...
                                    <tbody class="text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <a href="{{url('admin/edit/topics/'.$data->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                <i class="fa fa-edit blue"></i>
                                                </a>
                                                <a id="delete" href="{{url('admin/delete/topics/'.$data->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
