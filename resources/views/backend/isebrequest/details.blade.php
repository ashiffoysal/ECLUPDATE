							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-muted">IESB Booking</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item">
											<span class="bullet bg-gray-200 w-5px h-2px"></span>
								...
								<div class="card card-flush pt-3 mb-5 mb-lg-10" data-kt-subscriptions-form="pricing">
												...
												<div class="card-header">
													...
													<div class="card-title">
														<h2 class="fw-bolder">IESB Exam Booking Details</h2>
													</div>
													<!--begin::Card title-->
													<!--begin::Card toolbar-->
													<div class="card-toolbar">
													  
														<a href="{{url('admin/iesb/export/'.$data->id)}}" class="btn btn-light-primary" style="margin-left:5px;margin-right:5px;">Export PDF</a>
														<a href="{{url('admin/iesb/examconfirmation/'.$data->id)}}" class="btn btn-light-primary" style="margin-left:5px;margin-right:5px;">Exam Confirmation</a>
												   ...
												   <div class="col-md-12 grid-margin stretch-card">
									                <div class="card">
									                  <div class="card-body">
									                    ...
									                    <div class="row">
									                    	<form action="{{url('admin/main-iesb-payment/update')}}" method="post">
										                    	<div class="col-md-8">
																  <div class="form-group">
																   
																    <label for="exampleInputEmail1">Total Amount</label>
																   	<input  class="form-control" type="number" name="total_amount" value="{{ $data->total_amount }}">
																  </div>
																</div>
...
// 		$.ajax({
//              url: "{{  url('admin/get/proctorexam-booking-notes/') }}",
//              type:"GET",
//              data:{
//              	'id':id,
//              	'notes':notes,
