    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Course Request</h1>
                <!--end::Title-->
            </div>
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder fs-3 mb-1">All Course Request</span>
                                ...
                                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="dataTableExample1" class="data-table" style="width:100%">
                                    ...
                                    <thead class="text-center">
                                        <tr class="fw-bolder text-muted">
                                            ...
                                            <th class="min-w-140px">Candidate </th>
                                            
                                             <th class="min-w-140px">Booking Id </th>
                                             <th class="min-w-140px">Course Name </th>
                                    ...
                                    @foreach($allData as $key => $data)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $data->first_name  }}<br>{{$data->email }}<br>{{ $data->phone }}</a>
                                            </td>
                                             <td>
                                                <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $data->booking_id  }}</a>
                                            </td>
                                             <td>
                                                <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $data->course_name  }}</a>
                                            </td>
                                              <td>
                                                <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">£ {{ $data->total_amount  }}</a>
                                            </td>
                                            
                                            
                                             <td>
                                                @if($data->is_paid==1)
                                                <span class="badge badge-light-success">{{ $data->payment_option  }}</span>
                                                  @if($data->is_paid_verify==0)
                                               <br> <span style="color:red">payment not verified</span>
                                            ...
                                            <td>
                                                @if($data->is_seen==1)
                                                <span class="badge badge-light-success">seen</span>
                                                @else
                                            ...
                                            <td class="text-end">
                                                ...
                                                <a href="{{url('admin/course-purchase/details/'.$data->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                <i class="fas fa-pen-square blue"></i>
                                                </a>
                                                <a id="delete" href="{{url('admin/course-purchase/delete/'.$data->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
