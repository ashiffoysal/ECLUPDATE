        ...
        <div id="kt_content_container" class="container-fluid">
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Update Admin-user</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
            <div class="card">
                <form action="{{ url('admin/admin-user/update') }}" method="post" enctype="multipart/form-data">
                    @csrf
                        <!-- radio ends -->
                    <div class="row">
                                ...
                                <div class="tab-content pt-3" data-select2-id="select2-data-89-mk7z">
                                    <div class="tab-pane active" id="kt_builder_main" data-select2-id="select2-data-kt_builder_main">
                                                ...
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                   <select name="role" class="form-select form-select-solid" >
                                                    @foreach($allroles as $roles)
                                                       <option value="{{$roles->id}}" @if($edit->role==$roles->id) selected @endif>{{$roles->name}}</option>
                                                    @endforeach
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text" name="first_name" placeholder="Enter First Name" value="{{ $edit->first_name }}">
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text" name="last_name" placeholder="Enter Last Name" value="{{ $edit->last_name }}">
                                                </div>
                                                 @error('last_name')
                                                <div style="color:red">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text" name="phone" placeholder="Enter Phone" value="{{ $edit->phone }}">
                                                </div>
                                                @error('phone')
                                                <div style="color:red">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text" name="email" placeholder="Enter email" value="{{ $edit->email }}">
                                                </div>
                                                @error('email')
                                                <div style="color:red">{{ $message }}</div>
                                                @enderror
                                          ...
                                          <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <textarea class="form-control form-control-solid" name="address" placeholder="Enter Address">{{ $edit->address }}</textarea>
                                                </div>
                                                @error('address')
                                                <div style="color:red">{{ $message }}</div>
                                                @enderror
                                                ...
                                                <div class="col-md-6">
                                                        ...
                                                        <!--begin::Checkbox-->
                                                            <label class="form-check form-check-custom form-check-solid me-10">
                                                                <input class="form-check-input h-20px w-20px" type="checkbox" name="exam_date" value="1"  @if($edit->exam_date==1) checked="checked" @endif>
                                                 ...
                                                 <div class="col-md-6">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <label class="form-check form-check-custom form-check-solid">
                                                            <input class="form-check-input h-20px w-20px" type="checkbox" name="update_exam_date" value="1" @if($edit->update_exam_date==1) checked="checked" @endif>
                                            ...
                                            <div class="offset-3 col-lg-9 col-xl-4 row">
                                                    <div class="col-md-6">
                                                        <div class="d-flex align-items-center">
                                                            <!--begin::Checkbox-->
                                                            <label class="form-check form-check-custom form-check-solid me-10">
                                                                <input class="form-check-input h-20px w-20px" type="checkbox" name="create_exam_booking" value="1" @if($edit->create_exam_booking==1) checked="checked" @endif >
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--begin::Checkbox-->
                                                            <label class="form-check form-check-custom form-check-solid">
                                                                <input class="form-check-input h-20px w-20px" type="checkbox" name="student_list" value="1" @if($edit->student_list==1) checked="checked" @endif>
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-md-6">
                                                        <div class="d-flex align-items-center">
                                                            <!--begin::Checkbox-->
                                                            <label class="form-check form-check-custom form-check-solid me-10">
                                                                <input class="form-check-input h-20px w-20px" type="checkbox" name="all_exam" value="1" @if($edit->all_exam==1) checked="checked" @endif>
                                                  ...
                                                  <div class="col-md-6">
                                                        <div class="d-flex align-items-center">
                                                            <!--begin::Checkbox-->
                                                            <label class="form-check form-check-custom form-check-solid me-10">
                                                                <input class="form-check-input h-20px w-20px" type="checkbox" name="subjects" value="1" @if($edit->subjects==1) checked="checked" @endif >
                                               ...
                                               <div class="offset-3 col-lg-9 col-xl-4 row">
                                                <div class="col-md-6">
                                                      <div class="d-flex align-items-center">
                                                        ...
                                                        <label class="form-check form-check-custom form-check-solid">
                                                            <input class="form-check-input h-20px w-20px" type="checkbox" name="notification" value="1" @if($edit->notification==1) checked="checked" @endif>
