        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-place="true" data-kt-place-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Unverified Student List</h1>
                    <!--end::Title-->
                </div>
                        ...
                        <div class="card mb-5 mb-xl-8">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder fs-3 mb-1">All Unverified Student</span>
                            ...
                            <div class="card-body py-3">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3"
                                        id="dataTableExample1" class="data-table" style="width:100%;font-size:10px">
                                        <!--begin::Table head-->
                                        ...
                                        <tbody class="text-center" style="font-size:10px !important">
                                            @foreach ($allData as $key => $data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#"
                                                            class="text-dark text-hover-primary d-block mb-1 fs-6">{{ $data->name }}</a>
                                                        <br>
                                                    ...
                                                    <td>
                                                        <a href="#"
                                                            class="text-dark text-hover-primary d-block mb-1 fs-6">{{ $data->email }}</a><br>
                                                        <span style="color:red">unverified</span>
                                                    </td>
                                                    <td>
                                                        <a href="#"
                                                            class="text-dark text-hover-primary d-block mb-1 fs-6">{{ $data->phone }}</a>
                                                        <br>
                                                        @if ($data->second_payment_alert == 1)
                                                            <span style="color:red">Second Payment Alert Send(
                                                                {{ \Carbon\Carbon::parse($data->second_payment_date)->format('d/m/Y') }})</span>
                                                        @endif
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        @if ($data->instruction_to_house != null)
                                                            <span class="badge badge-warning">
                                                                {{ $data->instruction_to_house }} </span>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if ($data->exams)
                                                            <span class="badge badge-success">
                                                                {{ $data->exams->main_exam_type ?? '' }} </span>
                                                        @endif
                                                    ...
                                                    <td class="text-end">
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                            ...
                                                            <div class="menu-item px-3">
                                                                <a href="{{ url('/admin/student/details/' . $data->id) }}"
                                                                    class="menu-link px-3">View</a>
                                                            </div>
                                                            <div class="menu-item px-3">
                                                                <a href="{{ url('/admin/student/verify/' . $data->id) }}"
                                                                    class="menu-link px-3">Is Verified</a>
                                                            </div>
