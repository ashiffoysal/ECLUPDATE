        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Student Exam Request Manage (UNPAID)</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder fs-3 mb-1">All Student Exam Request(UNPAID)</span>
                        ...
                        <div class="card-body py-3">
                            ...
                            <div class="table-responsive">
                                ...
                                <form action="{{ url('admin/unvisible-update/data') }}" method="post">
            					@csrf
            					<button type="submit" style="margin: 5px;" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Unvisible All</button>
                                    ...
                                    @foreach($alldata as $key => $data)
                                        <tr>
                                         ...
                                         <a  href="{{url('admin/exambooking/maindetails/'.$data->id)}}">
                                            ...
                                            <span class="badge badge-warning">Candidate cannot see this booking</span>
                                            @endif
