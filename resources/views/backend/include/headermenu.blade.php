									...
									<div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_header_menu_mobile_toggle" data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
										...
										<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
											<div class="menu-item me-lg-1">
												<a class="menu-link" href="{{url('admin/candidate-exam-date/index')}}">
													<span class="menu-title badge badge-danger" style="color:#fff !important;">Candidate Exam Dates</span>
												</a>
											</div>
																						<div class="menu-item me-lg-1">
												<a class="menu-link" href="{{url('admin/date-wise/candidates')}}">
													<span class="menu-title badge badge-warning" style="color:#fff !important;">For Seating Plan</span>
												</a>
											</div>
											@php
											    $allseries=DB::table('examessuedates')->where('is_deleted',0)->get();
											@endphp
											
									@if(Auth::user()->create_exam_booking==1)
											<div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-lg-1">
												<span class="menu-link py-3">
													<span class="menu-title badge badge-success" style="color:#fff">Series</span>
													<span class="menu-arrow d-lg-none"></span>
												</span>
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
												@foreach($allseries as $seri)
													<div class="menu-item">
														<a class="menu-link py-3" href="{{url('admin/series-exam/booking/'.$seri->id)}}">
															<span class="menu-icon">
																<i class="bi bi-pencil fs-3"></i>
															</span>
															<span class="menu-title">{{ $seri->exam_name }}</span>
														</a>
													</div>
													@endforeach
										...
										@if(Auth::user()->contact_message==1)
											@php
											$contactmessage=DB::table('supports_inquiry')->where('is_contact',1)->where('is_seen',0)->count();
											@endphp
											<div class="menu-item me-lg-1">
												<a class="menu-link" href="{{route('admin.contactmessage.index')}}">
													<span class="menu-title">Message</span><span class="badge badge-success">{{ $contactmessage }}</span>
												</a>
											</div>
											@endif
												<div class="menu-item me-lg-1">
												<a class="menu-link" href="{{url('/admin/unpaid-candidate/index')}}">
													<span class="menu-title badge badge-danger menu-title" style="color:#fff !important">Unpaid </span>
												</a>
											</div>
											<div class="menu-item me-lg-1">
											    @php
											    $allSupmessage=DB::table('support_message')->where('sender_type',2)->where('is_seen',0)->count();
											    @endphp
												<a class="menu-link" href="{{url('admin/supports/create')}}">
													<span class="menu-title">Supports </span><span class="badge badge-danger">{{ $allSupmessage }}</span>
												</a>
											</div>
											
											<div class="menu-item me-lg-1">
												<a class="menu-link" href="{{url('admin/functional-skill-tuition/index')}}">
													<span class="menu-title">FS Tuition </span>
												</a>
											</div>
											<div class="menu-item me-lg-1">
												<a class="menu-link" href="{{url('admin/skill-exam/seating-plan/index')}}">
													<span class="menu-title">Seating Plan </span>
												</a>
											</div>
										
										    <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-lg-1">
												<span class="menu-link py-3">
													<span class="menu-title badge badge-warning" style="color:#fff">Invoice</span>
													<span class="menu-arrow d-lg-none"></span>
												</span>
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
													<div class="menu-item">
														<a class="menu-link py-3" href="{{url('admin/custom-invoice/create')}}">
															<span class="menu-icon">
																<i class="bi bi-grid fs-3"></i>
															</span>
															<span class="menu-title">Exam Centre Invoice</span>
														</a>
													</div>
													<div class="menu-item">
														<a class="menu-link py-3" href="{{url('admin/merit-custom-invoice/create')}}">
															<span class="menu-icon">
																<i class="bi bi-grid fs-3"></i>
															</span>
															<span class="menu-title">Merit Tutors Invoice</span>
														</a>
													</div>
													<div class="menu-item">
														<a class="menu-link py-3" href="{{url('admin/merit-custom-invoice/index')}}">
															<span class="menu-icon">
																<i class="bi bi-grid fs-3"></i>
															</span>
															<span class="menu-title">All Invoice</span>
														</a>
													</div>
											 ...
											 @php
											$pidcoint=App\Models\ExamRequest::orderBy('id','DESC')->where('is_completed_from',1)->where('is_deleted',1)->where('is_paid',1)->where('is_refunded',0)->where('is_confirm_booking',0)->count();
											@endphp
											...
											<div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-lg-1">
												<span class="menu-link py-3">
													<span class="menu-title badge badge-warning" style="color:#fff">Extra</span>
													<span class="menu-arrow d-lg-none"></span>
												</span>
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
													<div class="menu-item">
														<a class="menu-link py-3" href="{{url('admin/all-confirmation/bydate')}}">
															<span class="menu-icon">
																<i class="bi bi-grid fs-3"></i>
															</span>
															<span class="menu-title">AAT ACCA FS Exam Date & Time</span>
														</a>
													</div>
													...
													<div class="menu-item">
														<a class="menu-link py-3" href="{{ url('admin/exam-booking-igcse/create') }}">
													 	...
													 	@if(Auth::user()->create_exam_booking==1)
													<div class="menu-item">
														<a class="menu-link py-3" href="{{ url('/admin/paid-candidate/index') }}">
															<span class="menu-icon">
																<i class="bi bi-grid fs-3"></i>
															</span>
															<span class="menu-title">Paid Candidate</span><span class="badge badge-danger">{{ $pidcoint }}</span>
														</a>
													</div>
													<div class="menu-item">
														<a class="menu-link py-3" href="{{url('admin/cupon/create')}}">
															<span class="menu-icon">
																<i class="bi bi-grid fs-3"></i>
															</span>
														...
														<div class="menu-item">
														    @php
														    $countcomment=App\Models\BlobComment::where('is_published',0)->count();
														    @endphp
														<a class="menu-link py-3" href="{{url('/admin/blog-comment/index')}}">
															<span class="menu-icon">
																<i class="bi bi-grid fs-3"></i>
															</span>
															<span class="menu-title">Blog Comment</span><span class="badge badge-success">{{ $countcomment }}</span>
														</a>
													</div>
														<div class="menu-item">
														<a class="menu-link py-3" href="{{url('/admin/ucas/index')}}">
															<span class="menu-icon">
																<i class="bi bi-grid fs-3"></i>
															</span>
															<span class="menu-title">Ucas Request</span><span class="badge badge-success">{{ $ucascount }}</span>
														</a>
													</div>
													
												<div class="menu-item">
														<a class="menu-link py-3" href="{{url('admin/branch/index')}}">
															<span class="menu-icon">
																<i class="bi bi-grid fs-3"></i>
															</span>
															<span class="menu-title">Branch</span><span class="badge badge-success">2</span>
														</a>
													</div>
													<div class="menu-item">
														<a class="menu-link py-3" target="_blank" href="https://docs.google.com/spreadsheets/d/1B5ZGJj_QJKhsxrtgMDBlv3D9_3Umh8mRH_uA_A5Ahkw/edit#gid=0">
															<span class="menu-icon">
																<i class="bi bi-grid fs-3"></i>
															</span>
															<span class="menu-title">November</span><span class="badge badge-success">2023</span>
														</a>
													</div>
												    <div class="menu-item">
														<a class="menu-link py-3" target="_blank" href="https://docs.google.com/spreadsheets/d/1d2yRnGyJWyNFSQossb6vtZ99Tka8Tg50x17vuBQK3Dk/edit?usp=sharing">
															<span class="menu-icon">
																<i class="bi bi-grid fs-3"></i>
															</span>
															<span class="menu-title">June </span><span class="badge badge-success">2024</span>
														</a>
													</div>
													@endif
													
														<div class="menu-item">
														<a class="menu-link py-3" href="{{ url('/admin/for-checking/data') }}" target="__blank">
															<span class="menu-icon">
																<i class="bi bi-grid fs-3"></i>
															</span>
															<span class="menu-title">Checking Subject</span>
														</a>
													</div>
													
														<div class="menu-item">
														<a class="menu-link py-3" href="{{ url('/') }}" target="__blank">
															<span class="menu-icon">
																<i class="bi bi-grid fs-3"></i>
															</span>
