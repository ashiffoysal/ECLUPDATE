    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Paid Booking List</h1>
                <!--end::Title-->
            </div>
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0"> Paid Booking List  Manage</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                                ...
                                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="dataTableExample1" class="data-table" style="width:100%;font-size:12px" >
                                    ...
                                    <thead class="text-center">
                                        <tr class="fw-bolder text-muted">
                                            ...
                                            <th class="min-w-140px">Method</th>
                                            <th class="min-w-140px">Notes</th>
                                            
                                            <th class="min-w-140px">Confirmation</th>
                                         ...
                                         <a  href="{{url('admin/exambooking/maindetails/'.$data->id)}}">
                                            ...
                                            <td>
                                                ...
                                                @if($data->is_confirm_booking==1)
                                                 <span class="badge badge-light-priumary fs-7 fw-bolder">Booked</span>
                                                 @else
                                                     @if($data->is_refunded==1)
                                                        <span class="badge badge-light-danger fs-7 fw-bolder">Refunded</span>
                                                     @else
                                                     <span class="badge badge-light-danger fs-7 fw-bolder">Not Yet</span>
                                                     @endif
                                                 @endif
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true" style="">
                                                   ...
                                                   <div class="menu-item px-3">
                                                     ...
                                                     <div class="menu-item px-3">
                                                        <a href=" {{ url('/admin/exam-booking/iscompleted/'.$data->id) }}" class="menu-link px-3">Is iscompleted</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                </div>
                                                <!--end::Menu-->
