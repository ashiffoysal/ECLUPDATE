                    ...
                    <div class="card mb-5 mb-xl-8">
                        <!--begin::Header-->
                            ...
                            <h3 class="card-title align-items-start flex-column">
                               ...
                               <a href="{{ url('admin/booking-first-payment-all-send/send') }}" class="btn btn-danger">First Alert Email Send</a>
                               <a href="{{ url('admin/booking-second-payment-all-send/send') }}" class="btn btn-success mt-5">Second Alert Email Send</a>
                            </h3>
                        </div>
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
