        ...
        <div id="kt_content_container" class="container-fluid">
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Coupon</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
            <div class="card">
                <form action="{{ url('admin/cupon/create') }}" method="post" enctype="multipart/form-data">
                    @csrf
                        <!-- radio ends -->
                    <div class="row">
                                ...
                                <div class="tab-content pt-3" data-select2-id="select2-data-89-mk7z">
                                    <div class="tab-pane active" id="kt_builder_main" data-select2-id="select2-data-kt_builder_main">
                                        <div class="row mb-10">  
                                            ...
                                            <label class="col-lg-3 col-form-label text-lg-end">Coupon Code:<span class="required"></span></label>
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text" name="custom_cupon_code" placeholder="Enter Coupon Code" value="{{ $data->custom_cupon_code }}">
                                                  
                                                </div>
                                                @error('custom_cupon_code')
                                                <div style="color:red">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        </div>
                                          <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Coupon %:<span class="required"></span></label>
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="number" name="custom_cupon_percent" placeholder="Enter Coupon %" value="{{ $data->custom_cupon_percent }}">
                                                </div>
                                                @error('custom_cupon_percent')
                                                <div style="color:red">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        </div>
                                        <div class="row mb-10">
                                             <label class="col-lg-3 col-form-label text-lg-end">Active/Deactive:<span class="required"></span></label>
                                            <div class="col-lg-9 col-xl-7">
                                                <label class="form-check form-switch form-check-custom form-check-solid">
                                                    <input class="form-check-input" name="custom_cupon_status" type="checkbox" value="1" @if($data->custom_cupon_status==1) checked="checked" @endif>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-content pt-3" data-select2-id="select2-data-89-mk7z">
                                    <div class="tab-pane active" id="kt_builder_main" data-select2-id="select2-data-kt_builder_main">
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text" name="global_cupon_code" placeholder="Enter Coupon Code" value="{{ $data->global_cupon_code }}">
                                          ...
                                          <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="number" name="global_cupon_percent" placeholder="Enter Coupon %" value="{{ $data->global_cupon_percent }}">
                                                </div>
                                                @error('cupon_percent')
                                                <div style="color:red">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <label class="form-check form-switch form-check-custom form-check-solid">
                                                    <input class="form-check-input" name="global_cupon_status" type="checkbox" value="1" @if($data->global_cupon_status==1) checked="checked" @endif>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
