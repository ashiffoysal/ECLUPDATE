                                ...
                                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="dataTableExample1" class="data-table" style="width:100%;font-size:14px" >
                                    ...
                                    <thead class="text-center">
                                        <tr class="fw-bolder text-muted">
                                            ...
                                            <th class="min-w-140px">Exam</th>
                                            <th class="min-w-140px">Level</th>
                                            <th class="min-w-140px">Student</th>
                                    ...
                                    @foreach($alldata as $key => $data)
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <a href="{{url('/admin/student-request/view/'.$data->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                <i class="fas fa-eye blue"></i>
                                                </a>
                                                <a id="delete" href="{{url('/admin/student-request/delete/'.$data->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
