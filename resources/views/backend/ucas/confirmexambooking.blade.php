									...
									<div class="col-xl-12">
										...
										<div class="card mb-5 mb-xxl-8" id="subjectupdate_section">
											...
											<div class="card-body pb-0">
												...
												<form  class="form fv-plugins-bootstrap5 fv-plugins-framework" action="{{url('admin/ucas-test/confirmation/submit')}}" method="post" enctype='multipart/form-data'>
												    @csrf
													<!--begin::Heading-->
													...
													<div class="row g-9 mb-8">
														...
														<div class="col-md-6 fv-row">
															...
															<input type="text" class="form-control form-control-solid" name="exam_type" required value="Mock Exam">
													...
													<div class="d-flex flex-column mb-8">
														...
														<textarea class="form-control form-control-solid" rows="3" name="details" placeholder=" Details" required>Thank you for booking your Ucas  Exam with ECL.Please find below your confirmation.
								                              ...
								                              <tbody>
								                                ...
								                                <tr>
								                                  ...
								                                  <td><a href="{{ url('/'.$exam->files) }}"  target="_blank"><label class="btn-sm btn-success" style="color:#fff">File</label></a></td>
								                                   ...
								                                   <td>
								                                       <a id="delete" href="{{ url('admin/ucas-confirmation/delete/'.$exam->id) }}"><i class="fa fa-times"></i></a>
								                                   </td>
