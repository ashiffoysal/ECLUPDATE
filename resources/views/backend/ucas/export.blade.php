			...
			<div class="toolbar" id="kt_toolbar">
				...
				<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
					...
					<div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
						<!--begin::Title-->
						<h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Candidate Exam Bookings</h1>
						<!--end::Title-->
						<!--begin::Separator-->
						...
						<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
							...
							<li class="breadcrumb-item text-muted">
								<a href="index.html" class="text-muted text-hover-primary">Booking Details</a>
							</li>
							<!--end::Item-->
							<!--begin::Item-->
							...
							<!--end::Item-->
							<!--begin::Item-->
							<li class="breadcrumb-item text-muted">Candidate Booking Details</li>
							<!--end::Item-->
							...
							<div class="d-flex flex-column flex-xl-row" id="printableArea">
								...
								<div class="flex-lg-row-fluid me-xl-18 mb-10 mb-xl-0">
									...
									<div class="mt-n1">
										...
										<div class="m-0">
											<!--begin::Label-->
											<div class="fw-bolder fs-3 text-gray-800 mb-8">Booking-ID #{{$data->ucas_booking_id}}</div>
											<!--end::Label-->
											<!--begin::Row-->
												...
												<div class="d-flex justify-content-end">
													...
													<div class="mw-300px">
														...
														<div class="d-flex flex-stack mb-3">
															...
															<!--end::Accountname-->
															<!--begin::Label-->
															<div class="text-end fw-bolder fs-6 text-gray-800">	£ {{ $data->total_subject_amount + $data->review_statement_amount + $data->doucment_check_amount }}</div>
															<!--end::Label-->
														</div>
														<!--end::Item-->
															<div class="d-flex flex-stack mb-3">
														...
														<div class="d-flex flex-stack mb-3">
															...
															<div class="text-end fw-bolder fs-6 text-gray-800">£ {{ $data->total_subject_amount + $data->review_statement_amount + $data->doucment_check_amount - $data->discount_amount }}</div>
															<!--end::Label-->
														</div>
														<!--end::Item-->
														<!--begin::Item-->
								...
								<div class="m-0">
									...
									<div class="border border-dashed border-gray-300 card-rounded h-lg-100 min-w-md-350px p-9 bg-lighten">
										...
										<div class="mb-2">
											...
											<div class="fw-bolder text-gray-800 fs-6">{{ $data->transaction_id }}
											</div>
										</div>
										<div class="mb-2">
											<div class="fw-bold text-gray-600 fs-7"></div>
											<div class="fw-bolder fs-6 text-gray-800">Exam Name:
											<a href="#" class="link-primary ps-1">UCAS Mock Exam</a>
											</div>
										...
										<div class="mb-6">
											...
											<div class="fw-bolder text-gray-800 fs-6">{{ $data->first_name }}</div>
										</div>
										<!--end::Item-->
										<!--begin::Item-->
										<!-- <div class="m-0">
