                                    ...
                                    @foreach($alldata as $key => $data)
                                        <tr>
                                            ...
                                            <td> {{ $data->ucas_booking_id }}
                                             ...
                                             <br> 
                                             @if( $data->is_seen==0)
                                                 <a href=""><span class="badge badge-danger">unseen</span> </a>
                                             @endif
                                             @if($data->is_confirmed==1)
                                             <a href=""><span class="badge badge-success">Confirmation Send</span> </a>
                                             @endif
                                             
                                            </td>
                                            <td> {{ $data->first_name}} {{ $data->last_name}}</td>
                                            <td><a style="color:black" href="">  {{ $data->email }} <br>  {{ $data->phone }} </a> </td>
                                            <td> {{ $data->created_at->format('d-M-Y') }} </td>
                                             <td>
                                                   
                                        @if($data->is_exam_completed==0) 
                                        <span class="btn-sm btn-danger" style="color:#fff; background:#0e1c0f  !important">Exam Not yet</span>
                                        
                                        @elseif($data->is_exam_completed==1) <span class="btn-sm btn-primary" style="color:#fff;">Exam completed</span>
                                        
                                         @elseif($data->is_exam_completed==2)
                                        <span class="btn-sm btn-danger" style="color:#fff;">Exam Canceled</span>@endif
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true" style="">
                                                    ...
                                                    <div class="menu-item px-3">
                                                     ...
                                                     <div class="menu-item px-3">
                                                        <a href="{{ url('admin/ucas-predicted-grades/index/'.$data->id) }}" class="menu-link px-3">Grades</a>
                                                    </div>
                                                   ...
                                                   <div class="menu-item px-3">
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{ url('admin/ucasbooking/iscompleted/'.$data->id) }}" class="menu-link px-3">Is Completed</a>
                                                    </div>
                                                    
                                                     <div class="menu-item px-3">
                                                        <a href="{{ url('admin/ucasbooking/iscancel/'.$data->id) }}" class="menu-link px-3">Is Canceled</a>
                                                    </div>
