...
@section('title', 'Exam Equipment Update')
@section('content')
...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card">
                <form action="{{ url('admin/exam-equipment/update') }}" method="post" enctype="multipart/form-data">
                    @csrf
                        <!-- radio ends -->
                    <div class="row">
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <select class="form-control form-control-solid"  name="subject_name"  id="subject_id">
                                                        ...
                                                        @php
                                                             $allsubject=App\Models\Subject::where('exam_type',$edit->exam_type)->where('exam_board',$edit->exam_board)->where('is_deleted',0)->select(['id','subject_name','unit_code'])->get();
                                                        @endphp
                                                        @foreach($allsubject as $subject)
                                                        <option value="{{ $subject->id }}" @if($edit->subject_id==$subject->id) selected @endif>{{ $subject->subject_name }} ( {{ $subject->unit_code }}  )</option>
                                                        @endforeach
                                                        </select>
                                           ...
                                           <div class="row mb-10">
                                                ...
                                                <div class="col-md-7">
                                                    <!--begin::Wrapper-->
                                                    <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                        <input class="form-control form-control-solid" type="text" name="paper" placeholder="Enter Paper Name" required value="{{ $edit->paper }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-10">
                                                ...
                                                <div class="col-md-7">
                                                    <!--begin::Wrapper-->
                                                    <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                        <input class="form-control form-control-solid" type="text" name="option_code" placeholder="Enter Option Code"  value="{{ $edit->option_code }}">
                                                    </div>
                                                </div>
                                            </div>
                                        <div id="main_section" style="display:;"> 
                                        @foreach(json_decode($edit->equipment_details) as $main)
                                            <div class="row mb-10">
