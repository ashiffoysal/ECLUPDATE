    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Exam Equipment Manage</h1>
                <!--end::Title-->
            </div>
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0"> Exam Equipment Manage</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder fs-3 mb-1">All Exam Equipment Manage</span><br>
                                <a href="{{url('admin/exam-equipment/create')}}" class="btn btn-success">Create Equipment</a>
                                ...
                                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="dataTableExample1" class="data-table" style="width:100%;font-size:12px" >
                                    ...
                                    <thead class="text-center">
                                        <tr class="fw-bolder text-muted">
                                            ...
                                            <th class="min-w-140px"> Papers </th>
                                            <th class="min-w-140px"> Equipment </th>
                                              <th class="min-w-140px"> More </th>
                                    ...
                                    @foreach($alldata as $key => $data)
                                        @php
                                            $mainexam=App\Models\Subject::where('id',$data->subject_id)->select(['subject_name','unit_code','id'])->first();
                                        @endphp
                                        <tr>
                                            <td>{{ $data->exam_type }} </td>
                                              <td>{{ $data->exam_board }} </td>
                                        
                                            <td> {{ $mainexam->subject_name }} ({{ $mainexam->unit_code }}) <br> </td>
                                            <td> {{ $data->paper }}</td>
                                            <td>  
                                            
        								    <table class="text-center" style="border:none">       @foreach(json_decode($data->equipment_details) as $details)
        							             <tr>
                                               ...
                                               <td class="text-end">
                                                ...
                                                <a href="{{url('admin/exam-equipment/edit/'.$data->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                <i class="fa fa-edit blue"></i>
                                                </a>
                                                <a id="delete" href="{{url('admin/exam-equipment/delete/'.$data->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
