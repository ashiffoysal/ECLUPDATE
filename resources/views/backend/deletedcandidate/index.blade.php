                        ...
                        <div class="card mb-5 mb-xl-8">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder fs-3 mb-1">All Soft Deleted</span>
                            ...
                            <div class="card-body py-3">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3"
                                        id="dataTableExample1" class="data-table" style="width:100%;font-size:12px">
                                        <!--begin::Table head-->
                                            ...
                                            @foreach ($allData as $key => $data)
                                                <tr>
                                                    ...
                                                    <td> {{ $data->booking_id }}
                                                        ...
                                                        @endif
                                                        <span
                                                            class="badge badge-danger">{{ $data->Candidate_number }}</span>
                                                    </td>
                                                    <td>
                                                        <a style="color:black"
                                                            href="{{ url('admin/exambooking/maindetails/' . $data->id) }}">
                                                            {{ $data->main_exam_type }} </a><br>
                                                    ...
                                                    <td> {{ $data->first_name }} {{ $data->last_name }}
                                                        ...
                                                        @if ($data->first_payment_alert == 1)
                                                            <span class="badge badge-danger">First Payment Alert Send
                                                                ({{ $data->first_payment_date }})</span>
                                                        @endif
                                                        @if ($data->second_payment_alert == 1)
                                                            <span class="badge badge-primary">Second Payment Alert Send
                                                                ({{ $data->second_payment_date }})</span> <br>
                                                        @endif
                                                    ...
                                                    <td> {{ $data->created_at->format('d-M-Y') }}
                                                        ...
                                                        <badge class="badge badge-primary">
                                                            {{ $data->mainseries->exam_name ?? '' }}</badge>
                                                    </td>
                                                    <td>
                                                        ...
                                                        @else
                                                            <span class="badge badge-success"> {{ $data->payment_option }}
                                                            </span> <br>
                                                        @endif
                                                        ...
                                                        @if ($data->enable_pay == 0)
                                                            <span style="color:primary">Payment Disabled</span>
                                                        @endif
                                                    ...
                                                    <td class="text-end">
                                                        <a href="#"
                                                            ...
                                                            data-kt-menu-flip="top-end">Manage
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                            ...
                                                            <div class="menu-item px-3">
                                                                <a id="delete"
                                                                    href="{{ url('admin/hard-delete/exambooking/' . $data->id) }}"
                                                                    class="menu-link px-3"
                                                                    data-kt-users-table-filter="delete_row">Hard Delete</a>
                                                            </div>
