                                    ...
                                    @foreach($alldata as $key => $data)
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                ...
                                                @if($data->is_ac==1)
                                                  <a href="{{url('/admin/subject/deactive/'.$data->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                <i class="fa fa-thumbs-up blue"></i>
                                                </a>
                                                @else
                                                     <a href="{{url('/admin/subject/active/'.$data->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
