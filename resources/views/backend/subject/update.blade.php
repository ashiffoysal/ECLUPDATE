                                                ...
                                                <div class="d-flex fw-bold h-100">
                                                    <!--begin::Checkbox-->
                                                       <div class="form-check form-check-custom form-check-solid me-9">
                                                        <input class="form-check-input" name="january_availability" type="checkbox" value="1" @if($edit->january_availability==1) checked @endif>
                                                        <label class="form-check-label ms-3" for="january_availability">January Series</label>
                                                    </div>
                                                    <!--end::Checkbox-->
                                                     <div class="form-check form-check-custom form-check-solid me-9">
                                                        <input class="form-check-input" name="june_availability" type="checkbox" value="1" @if($edit->june_availability==1) checked @endif>
                                                        <label class="form-check-label ms-3" for="june_availability">June Series</label>
                                                    </div>
                                                    
                                                    
                                                    <div class="form-check form-check-custom form-check-solid me-9">
                                                        <input class="form-check-input" name="november_availability" type="checkbox" value="1" @if($edit->november_availability==1) checked @endif>
                                                        <label class="form-check-label ms-3" for="november_availability">November Series</label>
                                                    </div>
                                                    
                                                      <div class="form-check form-check-custom form-check-solid me-9">
                                                        <input class="form-check-input" name="november_cie_availability" type="checkbox" value="1" @if($edit->november_cie_availability==1) checked @endif>
                                        ...
                                        <div class="row mb-10" id="mock_paper"  @if($edit->has_mock_test==0) style="display:none;"  @endif>
                                            ...
                                            <div class="col-xl-9">
                                                ...
                                                <div class="d-flex fw-bold h-100">
                                                    <!--begin::Checkbox-->
                                                    <div class="form-check form-check-custom form-check-solid me-9">
                                                        <input class="form-check-input" name="paper_1" type="checkbox" value="1" @if($edit->paper_1==1) checked @endif>
                                                        <label class="form-check-label ms-3" for="paper_1">Paper 1</label>
                                                    </div>
                                                    <!--end::Checkbox-->
                                                     <div class="form-check form-check-custom form-check-solid me-9">
                                                        <input class="form-check-input" name="paper_2" type="checkbox" value="1" @if($edit->paper_2==1) checked @endif>
                                                        <label class="form-check-label ms-3" for="paper_2">Paper 2</label>
                                                    </div>
                                                    
                                                     <div class="form-check form-check-custom form-check-solid me-9">
                                                        <input class="form-check-input" name="paper_3" type="checkbox" value="1" @if($edit->paper_3==1) checked @endif>
                                                        <label class="form-check-label ms-3" for="paper_3">Paper 3</label>
                                                    </div>
                                                    <!--begin::Checkbox-->
                                                      <div class="form-check form-check-custom form-check-solid me-9">
                                                        <input class="form-check-input" name="paper_4" type="checkbox" value="1" @if($edit->paper_4==1) checked @endif>
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-xl-9">
                                                ...
                                                <div class="d-flex fw-bold h-100">
                                                    <!--begin::Checkbox-->
                                                    <div class="form-check form-check-custom form-check-solid me-9">
                                                        <input class="form-check-input" name="no_exam_assesment" type="radio"  id="n_yes" value="1" @if($edit->no_exam_assesment == 1) checked @endif>
                                                        <label class="form-check-label ms-3" for="n_yes">Yes</label>
                                                    </div>
                                                    <!--end::Checkbox-->
                                                    <!--begin::Checkbox-->
                                                    <div class="form-check form-check-custom form-check-solid">
                                                        <input class="form-check-input" name="no_exam_assesment"  type="radio" value="0" id="n_no" @if($edit->no_exam_assesment == 0) checked @endif>
