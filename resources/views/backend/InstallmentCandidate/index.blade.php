...
@section('title', 'Candidate Installments')
@section('content')
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Candidate Installments Exam Request List</h1>
                <!--end::Title-->
            </div>
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Candidate Installments Exam Request Manage</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder fs-3 mb-1"> Candidate Installments List</span>
                                    ...
                                    @foreach($alldata as $key => $data)
                                        <tr>
                                         ...
                                         <a  href="{{url('admin/exambooking/maindetails/'.$data->id)}}">
                                            ...
                                            <td> @if($data->payment_option ==null) 
                                            <span class="badge badge-danger">unpaid</span> @else 
                                            ...
                                            @else
                                            <span class="text-danger">Payment is not Verified</span>
                                            @endif
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true" style="">
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{url('admin/Installments-candidate/payment/'.$data->id)}}" class="menu-link px-3">Payment</a>
                                                    </div>
                                                   <div class="menu-item px-3">
