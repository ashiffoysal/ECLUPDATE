    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Subject Exam Date Details</h1>
                <!--end::Title-->
            </div>
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Subject Details</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder fs-3 mb-1"> Subject Details</span>
                            </h3>
                                         ...
                                         <div class="row mb-10">
                                            ...
                                            <div class="col-lg-3 col-xl-3">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                 <input type="date" onchange="changedatefirst(this)" id="GCSE_Retake_entry_date" class="form-control form-control-solid " name="GCSE_Retake_entry_date" placeholder="Enter Entry Deadline" value="2023-09-28">
                                                </div>
                                            </div>
                                             <div class="col-lg-3 col-xl-3">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                 <input type="date" onchange="changedatefirst(this)" class="form-control form-control-solid" name="GCSE_Retake_late_entry_date" placeholder="Enter Late Fees Charge From" value="2023-09-29">
                                                </div>
                                            </div>
                                             <div class="col-lg-3 col-xl-3">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                 <input type="date" onchange="changedatefirst(this)" class="form-control form-control-solid" name="GCSE_Retake_high_late_entry_date" placeholder="Enter High Late Fees Charge From" value="2023-10-22">
                                                </div>
                                            </div>
                                        </div>
