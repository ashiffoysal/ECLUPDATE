                                ...
                                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="dataTableExample1" class="data-table" style="width:100%;font-size:14px" >
                                    ...
                                    <thead class="text-center">
                                        <tr class="fw-bolder text-muted">
                                          ...
                                          {{--
                                            <th class="min-w-100px">Last Update Date</th>
                                            --}}
                                            <th>more</th>
                                        </tr>
                                    </thead>
                                    ...
                                    @foreach($alldata as $key => $data)
                                        <tr>
                                            ...
                                            {{--
                                            <td>
                                             {{ $data->update_exam_date }}
                                            </td>
                                            --}}
                                            <td class="text-end">
															<a href="{{url('admin/examdate/subject/'.$data->id)}}" class="btn btn-bg-light btn-color-muted btn-active-color-primary btn-sm px-4">Edit</a>
											</td>
                                        </tr>
                                    @endforeach
                                    </tbody>
...
<script>
    function datechange(em){
        var val=em.value;
        var id=em.id;
          if(id) {
             $.ajax({
                 url: "{{  url('admin/examdate/update') }}",
                 type:"GET",
                 data:{
                    'id':id,
                    'val':val,
