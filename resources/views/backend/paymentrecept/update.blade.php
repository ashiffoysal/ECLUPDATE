...
<link rel="stylesheet" href="{{asset('backend')}}/assets/izitost.css">
    ...
    <title>UPDATE PAYMENT RECEIPT</title>
    <style>
        .bd-navbar {
    padding: 0.75rem 0;
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
     ...
     <a class="nav-link active" style="color:#fff !important" aria-current="page" href="{{ url('payment-receipt/index') }}">ALL RECEIPT</a>
        <a class="nav-link" style="color:#fff !important" href="{{ url('payment-receipt/create') }}">UPDATE RECEIPT</a>
        ...
        <div class="row">
                <div class="col-md-2 mt-2" style="text-align: end !important;">
                 ...
                 <div class="col-md-3 mt-2"> 
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="payment_type" id="inlineRadio1" value="CASH" @if($data->payment_type=='CASH') checked @endif>
                      <label class="form-check-label form-label" for="inlineRadio1">CASH</label>
                    </div>
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="payment_type" id="inlineRadio2" value="BANK" @if($data->payment_type=='BANK') checked @endif>
                      <label class="form-check-label form-label" for="inlineRadio2">BANK</label>
                    </div>
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="payment_type" id="inlineRadio3" value="CARD" @if($data->payment_type=='CARD') checked @endif>
            ...
            <div class="col-md-4">
               <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <input type="date" name="date" class="form-control" id="date" required value="{{ $data->date }}">
            ...
            <div class="col-md-3">
               <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  ...
                  <input type="text" class="form-control" id="invoicenumber" value="{{ $data->no }}" disabled>
                  <input type="hidden" class="form-control"  name="no" id="invoicenumber" value="{{ $data->no }}" >
                </div>
              </div>
            </div>
            <div class="col-md-6">
               <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="name" id="invoicenumber" required value="{{ $data->name }}">
                </div>
              </div>
            </div>
             <div class="col-md-6">
               <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="email" id="invoicenumber" required value="{{ $data->email }}">
                </div>
              </div>
            </div>
         </div>
                ...
                <table class="table" border="1">
                    ...
                    <tbody>
                        <tr>
                              <td>
                                  ...
                                  <input class="form-check-input" type="checkbox" value="1" id="flexCheckDefault" name="tuition_fees" @if($data->tuition_fees==1) checked  @endif>
                                
                              </td>
                              <td>Tuition Fees</td>
                              <td><input type="number" name="tuition_fees_amount" class="form-control" value="{{ $data->tuition_fees_amount }}"  @if($data->tuition_fees==1) @else disabled  @endif></td>
                              
                        </tr>
                        <tr>
                              <td>
                                  
                                  <input class="form-check-input" type="checkbox" value="1" id="flexCheckDefault" name="admission_fees" @if($data->admission_fees==1) checked  @endif>
                                
                              </td>
                              <td>Admission Fees</td>
                              <td><input type="number" class="form-control" value="{{ $data->admission_fees_amount }}" name="admission_fees_amount"  @if($data->admission_fees==1) @else disabled  @endif></td>
                              
                        </tr>
                         <tr>
                              <td>
                                  
                                  <input class="form-check-input" type="checkbox" value="1" name="child_care_fees" @if($data->child_care_fees==1) checked  @endif>
                                
                              </td>
                              <td>Child Care Fees</td>
                              <td><input type="number" class="form-control" value="{{ $data->child_care_fees }}" name="child_care_fees_amount"  @if($data->child_care_fees==1) @else disabled  @endif></td>
                              
                        </tr>
                         <tr>
                              <td>
                                  
                                  <input class="form-check-input" type="checkbox" value="1" id="flexCheckDefault" name="examination_fees" @if($data->examination_fees==1) checked  @endif>
                                
                              </td>
                              <td>Examination Fees</td>
                              <td><input type="number" class="form-control" value="{{ $data->examination_fees_amount }}" name="examination_fees_amount"  @if($data->examination_fees==1) @else disabled  @endif></td>
                              
                        </tr>
                         <tr>
                              <td>
                                  
                                  <input class="form-check-input" type="checkbox" value="1" id="flexCheckDefault" name="refundable_deposite_fees" @if($data->refundable_deposite_fees==1) checked  @endif>
                                
                              </td>
                              <td>Refundable Deposite Fees</td>
                              <td><input type="number" name="refundable_deposite_fees_amount" class="form-control" value="{{ $data->refundable_deposite_fees_amount }}"  @if($data->refundable_deposite_fees==1) @else disabled  @endif></td>
                              
                        </tr>
                          <tr>
                              <td>
                                  
                                  <input class="form-check-input" type="checkbox" value="1" name="resources" id="flexCheckDefault" @if($data->resources==1) checked  @endif>
                                
                              </td>
                              <td>Resources</td>
                              <td><input type="number" name="resources_amount" class="form-control" value="{{ $data->resources_amount }}"  @if($data->resources==1) @else disabled  @endif></td>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td>Total</td>
                            <td>
                                <span id="total_amount">£ {{ $data->total_amount }}</span> 
                                <input type="hidden" id="total_amount_hidden" name="total_amount_hidden" class="form-control" value="{{ $data->total_amount  }}">
                            </td>
                        </tr>
                    </tfoot>
                </table>
