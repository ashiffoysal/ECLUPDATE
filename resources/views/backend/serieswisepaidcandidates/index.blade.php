...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
   ...
   $allgcse=App\Models\ExamRequest::orderBy('id','DESC')->where('exam_series',$series_id)->where('is_completed_from',1)->where('is_confirm_booking',0)->where('is_refunded',0)->where('main_exam_type','GCSE')->where('is_deleted',1)->where('is_paid',1)->get();
...
@endphp
   ...
   $allgcse=App\Models\ExamRequest::orderBy('id','DESC')->where('exam_series',$series_id)->where('is_completed_from',1)->where('is_confirm_booking',0)->where('is_refunded',0)->where('main_exam_type','IGCSE')->where('is_deleted',1)->where('is_paid',1)->get();
...
@endphp
   ...
   $allgcse=App\Models\ExamRequest::orderBy('id','DESC')->where('exam_series',$series_id)->where('is_completed_from',1)->where('is_confirm_booking',0)->where('is_refunded',0)->where('main_exam_type','A Level')->where('is_deleted',1)->where('is_paid',1)->get();
...
@endphp
   ...
   $allgcse=App\Models\ExamRequest::orderBy('id','DESC')->where('exam_series',$series_id)->where('is_completed_from',1)->where('is_confirm_booking',0)->where('is_refunded',0)->where('main_exam_type','AS Level')->where('is_deleted',1)->where('is_paid',1)->get();
