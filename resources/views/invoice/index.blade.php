                            ...
                            <div class="table-responsive">
                                ...
                                @foreach(json_decode($data->exam_information) as $yes => $exam)
                                   ...
                                   <tr class="tr2">
                                        <td></td>
                                        <td></td>
                                        <td class="text-center">Special Access Document Checking Fee</td>
                                        <td class="text-end">£{{ $data->special_access_initial_fees }}</td>
                                    </tr>
                                   <tr class="tr2">
                                        <td></td>
                                        <td></td>
                                        <td class="text-center">Special Access Fee</td>
                                        <td class="text-end">£{{ $data->admin_specialaccess_amount }}</td>
                                    </tr>
                                    <tr class="tr2">
                                        <td></td>
                                        <td></td>
                                        <td class="text-center">Installment Fee</td>
                                        <td class="text-end">£{{ $data->Installment_fee }}</td>
                                    </tr>
                                      <tr class="tr2">
                                        <td></td>
                                        <td></td>
                                        <td class="text-center">Mock Fee</td>
                                        <td class="text-end">£{{ $data->mock_amount }}</td>
                                    </tr>
                                    ...
                                    <tr class="tr2">
                                        ...
                                        <td class="f-w-600 text-end active-color">£ {{  $data->special_access_initial_fees + $data->total_amount -$data->discount_amount + $data->admin_specialaccess_amount + $data->Installment_fee }}</td>
                                    </tr>
