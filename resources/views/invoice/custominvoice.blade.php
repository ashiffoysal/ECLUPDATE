...
<head>
  ...
  <title>Exam Centre London /Merit Tutors Invoice</title>
        ...
        <div class="tm_invoice_in">
          <div class="tm_invoice_head tm_top_head tm_mb15 tm_align_center">
            <div class="tm_invoice_left">
              <div class="tm_logo"> @if($data->service==2)<img src="https://www.examcentrelondon.co.uk/uploads/logo/logo_1662996021.png" alt="Logo">@endif @if($data->service==1)<img src="https://merittutors.co.uk/uploads/logo/logo_1648033550.png" alt="Logo">@endif</div>
            </div>
            <div class="tm_invoice_right tm_text_right tm_mobile_hide">
              <div class="tm_f50 tm_text_uppercase tm_white_color">Invoice<br>#{{ $data->invoice_id }}</div>
            </div>
          ...
          <div class="tm_invoice_info tm_mb25">
            ...
            <div class="tm_invoice_info_list tm_white_color">
              ...
              <p class="tm_invoice_date tm_m0"><b>@if($data->service==2) Date: {{ Carbon\Carbon::today()->format('d,M-Y') }} @endif @if($data->service==1)From Date: {{ $data->from_date }} - To Date: {{ $data->invoice_due_date }} @endif </b></p>
            </div>
          ...
          <div class="tm_invoice_head tm_mb10">
            <div class="tm_invoice_left">
              ...
              <p>
                Exam Centre London<br>
                54 Upton Lane, London E7 9LN, London <br>United Kingdom <br>
            ...
            <div class="tm_invoice_right tm_text_right">
              <p class="tm_mb2"><b class="tm_primary_color">Invoice For:</b></p>
              <p>
               {{ $data->invoice_for_name }}<br>
                {{ $data->invoice_for_address }}<br>
               {{ $data->invoice_for_email }}
              </p>
            </div>
          </div>
          <div class="tm_table tm_style1">
            <div class="">
              <div class="tm_table_responsive">
                <table>
                  ...
                  <tbody>
                      @foreach(json_decode($information) as $mydata)
                      @if($mydata->name !=null)
                        <tr>
                          <td class="tm_width_3">{{ $mydata->name }}</td>
                          <td class="tm_width_4">{{ $mydata->description }}</td>
                          <td class="tm_width_2">£{{ $mydata->price }}</td>
                          <td class="tm_width_1">{{ $mydata->quantity }}</td>
                          <td class="tm_width_2 tm_text_right">£ {{ floatval($mydata->price) * floatval($mydata->quantity)}}</td>
                        </tr>
                        @endif
                    @endforeach
            ...
            <div class="tm_invoice_footer tm_border_top tm_mb15 tm_m0_md">
              <div class="tm_left_footer">
                ...
                Account Name: EDU SERVICE LIMITED<br>
                Account Number: 18901601<br>
                Sort Code: 04-06-05 
                ...
                IBAN: GB25CLRB04060518901601<br>
                Swift code : CLRBGB22
                ...
                <table class="tm_mb15">
                  <tbody>
                    <tr class="tm_gray_bg ">
                      ...
                      <td class="tm_width_3 tm_primary_color tm_bold tm_text_right">£{{$total_price}}</td>
                    </tr>
              
                    <tr class="tm_accent_bg">
                      <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_white_color">Grand Total	</td>
                      <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_white_color tm_text_right">£{{$total_price}}</td>
                    </tr>
                     <tr class="tm_accent_bg">
                      <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_white_color">Paid Total	</td>
                      <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_white_color tm_text_right">£{{$data->paid_total}}</td>
                    </tr>
                  </tbody>
                </table>
                <br>
                 @if($data->is_paid==1)
                 <p class="tm_mb2"><b class="tm_primary_color"><span class="badge badge-success" style="background: #33c933;
    padding: 9px;
    color: #fff;
    border-radius: 7px;">PAID</span></b></p>
                 @endif
                 <br>
              </div>
            </div>
