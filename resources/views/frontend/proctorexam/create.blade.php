            ...
            <div class="col-md-12">
                <div class="sub_menu">
                    <ul>
                        ...
                        <li><a href="#">Proctor Exam Tuition</a></li>
                        <li><i class="fas fa-angle-right"></i></li>
                        <li><a href="#">Proctor Exam Tuition Booking</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="a_level_exams">
                    ...
                    <div class="a_level_exam_booking_form">
                        ...
                        <form action="{{ url('/proctor-exam') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-step active">
                                ...
                                <div class="single_form_parent single_form_parent_step2">
                                    <div class="single_form_step single_form_column3">
                                        <label for="id21">Subject Details <span>*</span></label>
                                        <input type="text" name="subject[]" placeholder="Please Enter Subject & Paper Details">
                                    </div>
                                    <div class="single_form_step single_form_column3">
