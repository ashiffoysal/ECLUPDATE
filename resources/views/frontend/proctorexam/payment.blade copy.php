                        ...
                        <ul>
	                		...
	                		@if($data->subject_details ==null)
								...
								@foreach(json_decode($data->subject_details) as $smainsub)
									...
									<li>{{$smainsub->subject ?? ''}}: £ {{ $smainsub->fees ?? '' }} ({{ $smainsub->hour }} Hours)</li>
                        ...
                        <div class="contact-form">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group" id="bank_new_payment" style="display:none;">
	                            <form method="post" action="{{ url('proctor-exam/bank/payment') }}" enctype="multipart/form-data">
										@csrf
										<div class="row clearfix">
							...
							<form action="{{ route('proctorexm.myonlinepayment.session') }}" method="POST">
