                                            ...
                                            <div class="quote-item">
                                                <div class="asif-tutor col-lg-12 row">
                                                    ...
                                                    <table class="table table-borderless">
                                                        ...
                                                        <tbody>
                                                            @foreach($alldata->unique('receiver_id') as $data)
                                                            <tr>
                                                                <td>
                                                                    @php
                                                                        $username=App\Models\User::where('id',$data->receiver_id)->select(['name'])->first();
                                                                    @endphp
                                                                    {{ $username->name }}
                                                                </td>
                                                                <td>{{ $data->message }}</td>
                                                                <td>{{  $data->created_at}}</td>
                                                                <td><a href="{{url('/student/message/view/'.$data->receiver_id)}}">
                                                                    <i class="fa fa-eye"></i>
                                                                </a></td>
                                                            </tr>
                                                            @endforeach
