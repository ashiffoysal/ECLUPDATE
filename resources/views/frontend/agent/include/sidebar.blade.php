          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{url('/agent/updateprofile')}}">Edit Profile</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ url('agent/updatepassword') }}">Password Update</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{ url('agent-exam-booking-list') }}">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ url('agent/notification') }}">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="general-pages">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="{{url('/agent/payment')}}"> Transection History</a></li>
                </ul>
              </div>
            </li>
               <li class="nav-item">
