      ...
      <section class="zh_exam_center section_padding" style="background-color: #fff;">
        <div class="container">
            <div class="zh_exam_center_heading ">
                <div class="zh_label">{{ $exam }} Past Papers</div>
            </div>
            <div class="row">
                @foreach($allSubject as $subject)
                <div class="col-md-3">
                    <a href="{{ url('/subject/past-papers',$subject->id) }}">
                        <div class="alert @if($exam=='GCSE') alert-success @endif  @if($exam=='IGCSE') alert-danger @endif @if($exam=='A Level') alert-info @endif @if($exam=='AS Level') alert-primary @endif" role="alert">
                          {{ $subject->subject_name }} {{  $subject->unit_code }}
                        </div>
                    </a>
                </div>
                @endforeach
