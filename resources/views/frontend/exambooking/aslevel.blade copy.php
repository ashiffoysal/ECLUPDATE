                            ...
                            <div class="mb-10 fv-row row">
                             ...
                             <div class="mb-10 fv-row row">
                                <div class="col-md-2" style="margin-bottom:8px">
                                  ...
                                  <!--end::Label-->
                                  <!--begin::Input-->
                                  <input type="hidden" name="type[]" value="AS Level">
  ...
  <script>
   function myseris(el){
        ...
        var series_id =$("#exam_series_0").val();
          ...
          if(type_id) {
             $.ajax({
                 url: "{{  url('/get/aslevel/subject/all/') }}/"+type_id+'/'+series_id,
                 type:"GET",
                 dataType:"json",
                 success:function(data) {
...
<script>
	...
	<script>
	    function myaddress(el){
	      
	        var post_code=el.value;
	        
	        $.ajax({
                 url: "{{  url('get/address/via-postcode/') }}",
                 type:"GET",
                  data: { 
                    'post_code':post_code,
                 },
