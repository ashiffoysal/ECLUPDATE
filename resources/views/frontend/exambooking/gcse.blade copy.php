                            ...
                            <div class="mb-10 fv-row row">
                             ...
                             <div class="mb-10 fv-row row">
                                <div class="col-md-2" style="margin-bottom:8px">
                                  ...
                                  <!--end::Label-->
                                  <!--begin::Input-->
                                  <input type="hidden" name="type[]" value="GCSE">
  ...
  <script>
   function myseris(el){
        ...
        var series_id =$("#exam_series_0").val();
         $.ajax({
                 url: "{{  url('/get/gcse/subject/all/') }}/"+type_id+'/'+series_id,
                 type:"GET",
                 dataType:"json",
                 success:function(data) {
