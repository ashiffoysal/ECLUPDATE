...
.form-control-lg {
  ...
  <section class="news-section style-two">
    <div class="pattern-layer" style="background-image:url(frontend/images/background/pattern-11.png)"></div>
    <div class="outer-container">
      <!-- Sec Title -->
      <div class="sec-title centered">
        <div class="title">EXAM BOOKING</div>
        <h2>GCSE EXAM BOOKING</h2>
        <div class="text">PLEASE CALL OR E-MAIL US IF YOU NEED ANY HELP WITH THE FORM<br>

PHONE: 02086162526 OR
<br>
E-MAIL: lNFO@EXAMCENTRELONDON.CO.UK </div>
      </div>
      <div class="inner-container">
        <div class="icon-layer-one" style="background-image:url(frontend/images/icons/icon-1.png)"></div>
        <div class="icon-layer-two" style="background-image:url(frontend/images/icons/icon-2.png)"></div>
        <div class="icon-layer-three" style="background-image:url(frontend/images/icons/icon-2.png)"></div>
                            ...
                            <div class="fv-row">
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-12">
                                  ...
                                  <!--end::Label-->
                                  <!--begin::Input-->
                                  <input type="text" class="form-control form-control-lg form-control-solid" name="first_name" placeholder="Please Enter Legal First name" value="{{ Auth::user()->name }}"/>
                                  <input type="hidden" name="main_exam_type" value="GCSE"/>
                                  <!--end::Input-->
                                </div>
                                <div class="col-lg-12 mt-2">
                                    <label for="inputPassword5" class="form-label">Middle name(s)</label>
                                ...
                                <div class="col-lg-12 mt-2">
                                    <label for="inputPassword5" class="form-label">Legal Last Name</label>
                                    <input type="text" name="last_name" id="inputPassword5" class="form-control form-control-lg form-control-solid" placeholder="Please Enter Legal Last Name" value="{{ Auth::user()->last_name }}"aria-describedby="passwordHelpBlock">
                                </div>
                                  <div class="col-lg-12 mt-2">
                                ...
                                <div class="col-lg-12 mt-3">
                                    ...
                                    <input type="file" name="recent_photo" id="recent_photo" class="form-control form-control-lg form-control-solid" accept=""><br>
                                    <span>(jpg, png only)</span>
                                </div>
                                <div class="col-lg-12 mt-3">
                                    <label for="PHOTO_ID" class="form-label">Photo ID</label>
                                    <input type="file"name="photo_id" id="PHOTO_ID" class="form-control form-control-lg form-control-solid" accept="">
                                    <span>(jpg, png only)</span>
                                </div>
                                <div class="col-lg-12 mt-2">
                                ...
                                <div class="col-lg-12 mt-2">
                                    <div class="mb-0 fv-row">
                                        <!--begin::Label-->
                                        <label class="d-flex align-items-center form-label mb-5">Has the candidate sat exams with us before?
                                        </label>
                                        <!--end::Label-->
                                        <!--begin::Options-->
                                        <div class="mb-0">
                                ...
                                <div class="col-lg-12 mt-2" id="has_a_candidate_section" style="display:none"> 
                                  ...
                                  <span>This will be on Previous Timetables and Results Information</span>
                                    <input type="text" name="has_a_candidate_number" id="" class="form-control form-control-lg form-control-solid" aria-describedby="passwordHelpBlock" max="4">
                                 </div> 
                                <div class="col-lg-12 mt-2">
                                    <div class="mb-0 fv-row">
                                        <!--begin::Label-->
                                ...
                                <div class="col-lg-12 mt-2" id="uci_section" style="display:none">
                                 ...
                                 <div class="col-lg-12 mt-2">
                                    <div class="mb-0 fv-row">
                                        <!--begin::Label-->
                                        <label class="d-flex align-items-center form-label mb-5">Do you have a ULN Number ( 10 digits )*
                                        </label>
                                        <!--end::Label-->
                                        <!--begin::Options-->
                                        <div class="mb-0">
                                 ...
                                 <div class="col-lg-12 mt-2" id="uln_section" style="display:none">
                                  <label for="UCI" class="form-label">ULN Number ( 13 digits )</label>
                                    <input type="text" max="10" name="uln_number" id="uln" class="form-control form-control-lg form-control-solid" aria-describedby="passwordHelpBlock">
                                 </div>
                          ...
                          <div class="w-100">
                           ...
                           <div class="col-lg-12 mt-2">
                            ...
                            <div class="col-lg-12 mt-2 fv-row">
                              ...
                              <input type="date" value="{{ Carbon\Carbon::now() }}" name="todays_date" class="form-control form-control-lg form-control-solid" aria-describedby="passwordHelpBlock">
                            </div>
                               ...
                               <p> Please note that the centre cannot provide refunds once the exam has been booked. We also cannot provide refunds if the candidate is absent from the exam.<p>
                                <br>
                                    ...
                                    <div class="fv-row">
                                        ...
                                        <a style="color:red" target="_blank" href="{{ url('/') }}">
                                            Terms & Condition(Payment & Refunds)</a>
                                        <br>
                                    </div>
                              </div>
                                {{-- 
