...
@section('title', 'Functional Skills Exam Booking')
@section('content')
                  ...
                  <div class="card-body">
                   ...
                   <div data-kt-stepper-element="content">
                          ...
                          <div class="w-100">
                            ...
                            <div class="pb-10 pb-lg-15">
                             ...
                             <div class="mb-10 fv-row row" >
                                ...
                                <div class="col-md-3">
                                  ...
                                  <!--end::Label-->
                                  <!--begin::Input-->
                                   <select onchange="UpdateChange(this)" name="exam_series" id="exam_series_0" class="form-select form-select-lg form-select-solid">
                                ...
                                <div class="col-md-3" style="margin: 0px 5px;" id="section_forest_gate_0">
                                        <div class="mb-0 fv-row">
                                          ...
                                          <!--begin::Options-->
                                          <div class="mb-0 row">
                                          <input id="mydate_0" type="text" name="fg_exam_date[]" class="datepicker form-control form-control-lg form-control-solid exam_date">
                                   ...
                                   <div class="col-md-3" style="margin: 0px 5px; display:none" id="section_ilford_lane_0">
                                        <div class="mb-0 fv-row">
                                          <!--begin::Label-->
                                          <label class="form-label mb-3">
                                          Choose the dates<span style="color: red;">*</span>
                                          ...
                                          <!--begin::Options-->
                                          <div class="mb-0 row">
                                          <input id="mydate_0" type="text" name="il_exam_date[]" class="datepickers form-control form-control-lg form-control-solid exam_date">
                                          <span class="warring_message_0"></span>
                                  ...
                                  <div class="col-md-2" style="">
                                    <div class="mb-0 fv-row">
                                    <!--begin::Label-->
                                    <label class="form-label mb-3">Exam Time 
                                    </label>
                                    <!--end::Label-->
                                    <!--begin::Options-->
                                    <div class="mb-0 row">
                                    
                                    <select id="start_exam_time_0" class="form-select form-select-lg form-select-solid" name="start_exam_time[]">
                            ...
                            <div class="mb-10 fv-row row" style="display: none" id="second_field">
                              <hr>
                              <div class="col-md-2" style="">
                                  <label class="form-label mb-3">EXAM BOARD</label>
                                  <!--end::Label-->
                              ...
                              <div class="col-md-3">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                 <select onchange="UpdateChange(this)" name="exam_series" id="exam_series_1" class="form-select form-select-lg form-select-solid">
                               ...
                               <div class="col-md-2">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <select name="type[]" id="type_1"  class="form-select form-select-lg form-select-solid type">
                                  <option value="Level 1">Level 1</option>
                                  <option value="Level 2">Level 2</option>
                                  <option value="Level 3">Level 3</option>
                              ...
                              <div class="col-md-4">
                                  <!--begin::Label-->
                                 <label class="form-label mb-3">SUBJECT <span style="color: red;">*</span></label>
                                 <select name="subject[]" onchange="subjectcheange(this)" id="subject_1"  class="form-select form-select-lg form-select-solid subject">
                                    <option disabled selected>--Select--</option>
                                    @foreach($allsub as $sub)
                                    <option value="{{  $sub->id }}">{{  $sub->subject_name }}</option>
                                    @endforeach
                              ...
                              <div class="col-md-2">
                                ...
                                <!--begin::Input-->
                               <!--  <input type="text" class="form-control form-control-lg form-control-solid" name="option_code[]" id="option_code_0" /> -->
                                 <select name="option_code[]" id="option_code_1"  class="form-select form-select-lg form-select-solid type">
                                  <option value="On Screen">On Screen</option>
                                  <option value="On Paper">On Paper</option>
                              ...
                              <div class="col-md-3" style="margin: 0px 5px;" id="section_forest_gate_1">
                                      <div class="mb-0 fv-row">
                                        <!--begin::Label-->
                                        <label class="form-label mb-3">
                                        Choose the dates<span style="color: red;">*</span>
                                        ...
                                        <!--begin::Options-->
                                        <div class="mb-0 row">
                                        <input id="mydate_1" type="text" name="fg_exam_date[]" class="datepicker form-control form-control-lg form-control-solid exam_date">
                                        <span class="warring_message_1"></span>
                                          
                                        </div>
                                        <!--end::Options-->
                                      </div>
                                </div>
                                 <div class="col-md-3" style="margin: 0px 5px; display:none" id="section_ilford_lane_1">
                                      <div class="mb-0 fv-row">
                                        <!--begin::Label-->
                                        <label class="form-label mb-3">
                                        Choose the dates<span style="color: red;">*</span>
                                        ...
                                        <!--begin::Options-->
                                        <div class="mb-0 row">
                                        <input id="mydate_1" type="text" name="il_exam_date[]" class="datepickers form-control form-control-lg form-control-solid exam_date">
                                        <span class="warring_message_1"></span>
                                ...
                                <div class="col-md-2" style="">
                                  ...
                                  <select id="start_exam_time_1" class="form-select form-select-lg form-select-solid" name="start_exam_time[]">
                                    <option selected disabled>Select</option>
                               ...
                               <div class="col-md-2">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-lg form-control-solid" id="fees_demo_1" disabled/>
                                <input type="hidden" class="fees" name="fees[]" id="fees_1"/>
                                 <input type="hidden" id="totalmain_amount" class="totalmain_amount" value="0" />
                              ...
                              <div class="col-md-2">
                                ...
                                <a  onclick="del()" style="color: red; cursor:pointer"><i class="fa fa-times"  style="color: red;"></i></a>
                            ...
                            <div class="mb-10 fv-row row" id="add_more_button">
                              <div class="col-md-12 text-end">
                                <button type="button" onclick="addmoresection()" class="btn-sm btn-success" style="color: #fff;">Add Subjects</button>
                              </div>
                            </div>
                              ...
                              <div class="mb-10 fv-row row">
                                ...
                                <div class="col-lg-10 mt-2" id="retaking_section"  @if($maindata) @if($maindata->retaking_exams=='yes') @else  style="display:none" @endif @else  style="display:none" @endif>
                            ...
                            <div class="row" style="margin:10px 0px">
                              <div class="col-md-12">
                               ...
                               <p> Our exam fees can be found on the website or you can call us at 02086162526. We cannot make entries until we have received the full payment. We accept payment via cash,card, bank transfer. The centre does not accept cheques as a method of payment.</p>
                                <br>
                                <h5>Refund</h5>
                               <p> Please note that the centre cannot provide refund once the exam has been booked. We also cannot provide refund if the candidate is absent from the exam.<p>
                                <br>
...
<script>
    ...
    <script>
            const picker = document.getElementById('date0');
    ...
    // for forest gate
       ...
       var date = new Date();
        $('.datepicker').datepicker({
          ...
          var index_id=ev.delegateTarget.id;
          var mydate=ev.delegateTarget.value;
                ...
                $.ajax({
                     ...
                     success:function(data) {
                        console.log(data);
                            ...
                            $('#start_exam_time_'+main_i).empty();
                            $.each(data,function(index,districtObj){
                             $('#start_exam_time_'+main_i).append('<option value="' + districtObj.time + '">'+districtObj.time+'</option>');
                          });
     ...
     <script type="text/javascript">
        ...
        $('.datepickers').datepicker({
            ...
            daysOfWeekDisabled: [0,5,6,2,1,4],
        }).on('changeDate', function(ev){
...
<script>
    function UpdateChange(el){
          ...
          if(val=='Forest Gate'){
              $("#section_forest_gate_"+main_i).show();
              $("#section_ilford_lane_"+main_i).hide();
              $('#start_exam_time_'+main_i).empty();
              $('#mydate_'+main_i).empty();
          }
          if(val=='Ilford Lane'){
              $("#section_forest_gate_"+main_i).hide();
              $("#section_ilford_lane_"+main_i).show();
              $('#start_exam_time_'+main_i).empty();
              $('#mydate_'+main_i).empty();
          }
...
<script>
    var i=1;
    function addmore(){
        $("#add_more").append('<div class="mb-10 fv-row row"><div class="col-md-2" style=""><label class="form-label mb-3">EXAM BOARD</label><select name="exam_board[]" class="form-select form-select-lg form-select-solid"><option value="Edexcel">Edexcel</option></select></div><div class="col-md-3"><label class="form-label mb-3">Branch</label><select name="exam_series[]" id="exam_series_'+i+'" class="form-select form-select-lg form-select-solid">@foreach($allbranch as $branch)<option value="{{ $branch->name }}">{{ $branch->name }}</option>@endforeach </select></div><div class="col-md-2"><label class="form-label mb-3">Exam Level</label><select name="type[]" id="type_'+i+'" data-id="'+i+'" class="form-select form-select-lg form-select-solid type"><option value="Level 1">Level 1</option><option value="Level 2">Level 2</option><option value="Level 3">Level 3</option></select></div><div class="col-md-4"><label class="form-label mb-3">SUBJECT</label><select name="subject[]" id="subject_'+i+'" onchange="subjectcheange(this)" data-id="'+i+'" class="form-select form-select-lg form-select-solid subject"><option disabled selected>Select</option>@foreach($allsub as $sub)<option value="{{  $sub->id }}">{{  $sub->subject_name }}</option>@endforeach</select></div><div class="col-md-3"><label class="form-label mb-3">Exam Type</label><select name="option_code[]" id="option_code_'+i+'"  class="form-select form-select-lg form-select-solid type"><option value="On Screen">On Screen</option><option value="On Paper">On Paper</option></select></div><div class="col-md-3" style="margin: 0px 5px;" id="section_forest_gate_'+i+'"><div class="mb-0 fv-row"><label class="form-label mb-3">Choose the dates*</label><div class="mb-0 row"><input type="text" id="exam_date_'+i+'" name="exam_date[]" class="datepicker form-control form-control-lg form-control-solid"></div></div></div><div class="col-md-3" style="margin: 0px 5px; display:none" id="section_ilford_lane_'+i+'"><div class="mb-0 fv-row"><label class="form-label mb-3">Choose the dates*</label><div class="mb-0 row"><input type="text" id="exam_date_'+i+'" name="exam_date[]" class="datepickers form-control form-control-lg form-control-solid"></div></div></div><div class="col-md-3" style=""><div class="mb-0 fv-row"><label class="form-label mb-3">What time to start your exam?</label><div class="mb-0 row"><select class="form-select form-select-lg form-select-solid" name="start_exam_time[]"><option selected disabled>Select</option></select></div></div></div><div class="col-md-2"><label class="form-label mb-3">FEES</label><input type="text" class="form-control form-control-lg form-control-solid" id="fees_demo_'+i+'" disabled/><input type="hidden" class="amount_fees" name="fees[]" id="fees_'+i+'"/><a style="color:red;padding:0px 4px" onclick="deleterow(this)" style="cursor:pointer;color:red">Delete</a></div></div>');
      i++
