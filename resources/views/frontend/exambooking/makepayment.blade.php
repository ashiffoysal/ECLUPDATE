                ...
                <div class="col-md-12">
                    <div class="sub_menu">
                        <ul>
                            ...
                            <li><a href="#">{{ $data->main_exam_type ?? '' }} Exam</a></li>
                            <li><i class="fas fa-angle-right"></i></li>
                            <li><a href="#">{{ $data->main_exam_type ?? '' }} Exam Booking</a></li>
                            <li><i class="fas fa-angle-right"></i></li>
...
{{--
        @if ($entryDate && $todayDate <= $entryDate)
        @else
            @if (
                    ...
                    <ul class="nav nav-pills" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                                ...
                                aria-selected="false">I want to pay in Instalments</button>
                        </li>
                    </ul>
                </div>
            @endif
                                                ...
                                                <div class="payment_tabs_table">
                                                    ...
                                                    <div class="table_design_default">
                                                        ...
                                                        <p>
                                                            Total
                                                            <span>£
                                                                {{ $data->ucas_reference_fee + $mainprice + $mockprice - $data->discount_amount + $data->admin_specialaccess_amount + $data->special_access_initial_fees }}</span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <form action="{{ route('myonlinepayment.session') }}" method="POST">
                                                        ...
                                                        <div class="payment_content_btn">
                                                            <button type="submit" class="btn_style"><b>£
                                                                    {{ $data->ucas_reference_fee + $mainprice + $mockprice - $data->discount_amount + $data->admin_specialaccess_amount + $data->special_access_initial_fees }}</b>
                                                                Pay with Card Now <span><img
                                                                        src="{{ asset('frontend/updatedesign') }}/assets/images/home/arrow-right.png"
                                                                        alt=""></span></button>
                                                        </div>
                                                    </form>
                                                    ...
                                                    <form action="{{ url('bank/payment') }}" method="POST"
                                                        ...
                                                        <div class="payment_bank_contents">
                                                            ...
                                                            <input type="hidden" name="amount"
                                                                value="{{ $data->ucas_reference_fee + $mainprice + $mockprice + $data->admin_specialaccess_amount - $data->discount_amount + $data->special_access_initial_fees }}">
                                                            <input type="hidden" name="booking_id"
                                                                value="{{ $data->booking_id }}">
