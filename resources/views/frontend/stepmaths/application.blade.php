...
@section('title', 'Step Mathematics Exam Booking')
@section('content')
            ...
            <div class="col-md-12">
                <div class="sub_menu">
                    <ul>
                        ...
                        <li><a href="{{url('/step-maths-exam-centre')}}">Step Mathematics Exam </a></li>
                        <li><i class="fas fa-angle-right"></i></li>
                        <li><a href="{{url('/step-maths-exam-application')}}">Step Mathematics Exam Booking</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="a_level_exams">
                    <div class="section_title high_standard_title">
                        <b>Step Mathematics Exam Booking</b>
                    ...
                    <div class="a_level_exam_booking_form">
                        ...
                        <form action="{{ url('/step-maths-exam-application') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="single_form_parent single_form_parent_step2">
                                    <div class="single_form_step single_form_column3">
                                        ...
                                        <select name="subject[]">
                                            ...
                                            <option value="Step Maths Paper 1">Step Maths Paper 1</option>
                                            <option value="Step Maths Paper 2">Step Maths Paper 2</option>
                                            <option value="Step Maths Paper 3">Step Maths Paper 3</option>
                                        </select>
                                    </div>
                                    </div>
                                    <div class="single_form_step single_form_column3">
                                    ...
                                    <div class="single_form_step single_form_column3">
                                        ...
                                        <div class="single_form_select">
                                                <input  type="text" name="exam_date[]" disabled required>
