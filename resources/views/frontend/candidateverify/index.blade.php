            ...
            <div class="row">
                <div class="col-md-12 align-self-center">
                   <form class="row g-3">
                    <div class="col-md-8">
                        <div class="mb-3">
                          <label for="exampleFormControlInput1" class="form-label">Candidate ID</label>
                          <input type="number" class="form-control" id="exampleFormControlInput1" placeholder="Enter Candidate ID" Required>
                        </div>
                        <div class="mt-4">
                ...
                <div class="col-md-12 ">
                  ...
                  <div class="profile-header">
                    ...
                    <div class="profile-nav-info">
                      ...
                      <div class="address">
                        <p id="state" class="state">Candidate ID:</p>
                        <span id="country" class="country">1234</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="main-bd">
                    <div class="left-side">
                      <div class="profile-side">
                        ...
                        <p class="user-mail"><i class="fa fa-calendar"></i> Brightisaac80@gmail.com</p>
                        <div class="profile-btn">
                          <button class="chatbtn" id="chatBtn"><i class="fa fa-comment"></i> </button>
                          <button class="createbtn" id="Create-post"><i class="fa fa-plus"></i> </button>
                        </div>
                    ...
                    <div class="right-side">
                      ...
                      <div class="nav">
                        <ul>
                          <li class="user-post active">Photo ID && Recent Photo</li>
