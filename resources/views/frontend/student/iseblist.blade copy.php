...
@section('title', 'Student ISEB Booking List ')
@section('content')
<style>
    .auto-container {
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description">All ISEB Booking list 
                    </p>
                    <div class="table-responsive">
                    <table class="table table-hover " id="dataTableExample1" style="width:100%;font-size:14px">
                        <thead>
                                    <tr>
                                        <th scope="col">#</th>
                                    ...
                                    <tr>
                                        <td>{{ ++$key}}</td>
                                          <td>
                                              ...
                                              <a class="badge badge-gradient-success" href="{{ url('iseb-exam/details/'.$data->booking_id) }}">Details</a> 
                             
                                        @if($data->is_paid_verify==0)
                                            <a class="badge badge-gradient-primary" href="{{ url('iseb-exam/make-payment/'.$data->booking_id) }}">Pay</a> 
                                        @endif
