...
@section('title', 'Candidate ISEB Booking List')
@section('content')
                                                  ...
                                                  <tr>
                                                    <td>{{ ++$key }}</td>
                                                      <td class="debl_table_btn_main">
                                                        ...
                                                        <a class="debl_table_btn debltb2" href="{{ url('iseb-exam/details/'.$data->booking_id) }}">Details</a> 
                                           
                                                        @if($data->is_paid_verify==0)
                                                            <a class="debl_table_btn debltb1" href="{{ url('iseb-exam/make-payment/'.$data->booking_id) }}">Pay</a> 
                                                        @endif
