                ...
                <div class="card">
                  <div class="card-body">
                        <!--  -->
                             ...
                             <section class="msger" style="height:600px; overflow: scroll;">
                                                            <main class="msger-chat">
                                             
                                                        @foreach($allsms as $sms)
                                                            @if($sms->is_admin_send==1)
                                                                <div class="msg left-msg">
                                                                    ...
                                                                    <div class="msg-bubble">
                                                                        ...
                                                                        <div class="msg-info-time">{{ $sms->created_at }}</div>
                                                                        </div>
                                                            ...
                                                            <form action="{{ url('/user/notification') }}" method="post" class="msger-inputarea">
                                                                @csrf
                                        ...
                                        <div class="row">
                                            <div class="quote-item">
                                                <div class="asif-tutor col-lg-12 row">
                                                    <!--  -->
                                                    <div class="content">
                                                        <h6>Notification And Reply</h6>
                                                    </div>
                                                    <!-- 

                                                     -->
                                                     <section class="msger" style="height:450px; overflow: scroll;">
                                                            <main class="msger-chat">
