                            ...
                            <div class="row">
                                ...
                                <p>Course Order Details</p>
                                    <div class="asif-tutor col-lg-12 row">
                                        ...
                                        <br>
                                        <div class="col-md-12">
                                            <label for="" style="font-weight:500">Total Hours:</label> <span> {{ $data->Course->total_hour }} </span>
                                        </div>
                                       
                                        <br>
                                        <div class="col-md-12">
                                            <label for="" style="font-weight:500">Total Amount :</label> <span>{{ $data->Course->total_amount }} £</span>
                                        </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="quote-item">
                                    <div class="asif-tutor col-lg-12 row">
                                        <div class="col-md-6">
                                            <label for="" style="font-weight:500">Total Hours(You purchase):</label> <span>  {{$data->Course->total_hour}} Hours</span>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="" style="font-weight:500">Paid Hours:</label><span> {{$data->Course->paid_hour}} Hours</span>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="" style="font-weight:500"> Paid Due Hours :</label><span> {{$data->Course->due_hour}} hours</span>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="" style="font-weight:500">Total Amount:</label><span>{{$data->Course->intotal_amount}} £</span>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="" style="font-weight:500">Paid Amount:</label><span> {{$data->Course->paid_amount}} £</span>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="" style="font-weight:500">Discount Amount:</label><span> @if($data->Course->discount_amount==null) 0 £ @else {{$data->Course->discount_amount}} £ @endif</span>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="" style="font-weight:500">Due Amount:</label><span> {{$data->Course->due_amount}} £</span>
                                        </div>
