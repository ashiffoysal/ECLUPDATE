    ...
    color: #009879;
      ...
      <section class="cource-detail-banner-section text-center">
		...
		<div class="auto-container">
		  ...
		  <section class="contact-page-section installments">
		          <div class="auto-container">
                        <div class="row clearfix">
                            <div class="offset-2 col-md-10 text center mt-10">
                                <p>
    ...
    <section class="contact-page-section" id="Installments" style="display:none">
                <div class="auto-container">
                        <div class="row clearfix">
                            <div class="col-md-12 mt-10">
                                  <div class="alert alert-success new2 p-4">
								       ...
								       <span class="alert-body">
								         ...
								         <p class="mb-0" style="color:black !important;font-size:16px">Thank you for selecting Installments. We are basically taking money in 2 installments. You must pay the fees on the next date. Otherwise we will not be able to book the exam.</p>
								       </span>
								    </div> 
                            </div>
                            <div class="col-md-6">
                                ...
                                <table class="styled-table">
                                    ...
                                    <tbody>
                                         ...
                                         <tr>
                                            ...
                                            <td>{{ Carbon\Carbon::today()->addDays(30)->format('d-m-Y'); }}</td>
                                        </tr>
                            ...
                            @php
                                $price=$mainprice + $mockprice - $data->discount_amount;
							...
							<form action="{{ route('myonlinepayment.session') }}" method="POST">
	                              ...
	                              <input type="hidden" name="main_id" id="cu_main_id" value="{{ $data->id }}">
	                              <input type="hidden" name="user_id" id="cu_user_id" value="{{ $data->user_id }}">
								  <button class="theme-btn btn-style-five" type="submit" id="checkout-live-button">Click here to pay with card ( £ {{ $ilstrumentamount }} )</button>
							</form>
							--}}
							
							<div class="form-group" id="bank_new_payment">
	                            <form method="post" action="{{ url('/bankpayment-installment/session') }}" enctype="multipart/form-data">
										...
										<div class="row clearfix">
											...
											<input type="hidden" name="second_installment_date" value="{{ Carbon\Carbon::today()->addDays(30)->format('d-m-Y'); }}">
											<input type="hidden" name="total_amount" value="{{ $price }}">
											<input type="hidden" name="installment_amount" value="{{ $ilstrumentamount }}">
						                    <input type="hidden" name="booking_id" value="{{ $data->booking_id }}">
