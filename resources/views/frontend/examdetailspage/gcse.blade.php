...
@section('title', 'GCSE Exams | Book Your GCSE Exam in London | Exam Centre London')
@section('meta_description', 'Secure your place for GCSE exams at Exam Centre London. We offer a wide range of subjects, including Maths, English, Science, and more. Convenient locations in East London. Book now!')
@section('content')
			...
			<div class="col-md-12">
				<div class="sub_menu">
					<ul>
						...
						<li><a href="{{ url('/exam-booking-gcse') }}">GCSE Exam</a></li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="col-md-12">
				<div class="a_level_exams">
					<div class="section_title high_standard_title">
						<b>GCSE Exam</b>
						<h2>Comprehensive <span>GCSE Examination</span> and <span>Tuition Services</span></h2>
						<p>We offer tailored support for learners accessing the following forms of GCSE examinations: GCSE | IGCSE | International GCSE.
					...
					<div class="contact_us a_level_exams_subjects">
						...
						<div class="contact_us_right a_level_exams_right">
							<div class="a_level_exams_right_title">
								<h3>GCSE SUBJECTS</h3>
								<p>We offer a wealth of different GCSE options and are always happy to consider offering a subject of your choice if not listed below. Please get in touch to chat through your requirements and we’ll be happy to help.</p>
							</div>
				...
				<div class="a_lavel_exam_bodies">
					...
					<div class="a_lavel_exam_bodies_calender">
						...
						<div class="a_lavel_exam_bodies_calender_contents">
							...
							<p>We offer GCSE(Only Edexcel,AQA,WJEC,OCR) Re-Sit Examinations in November. This is a popular option for School and College Leavers who wish to improve their grade(s). <br>Please contact us on 0208 616 25 26 for more information.</p>
			...
			<div class="col-md-12">
				<div class="a_lavel_exam_booking">
					<div class="a_lavel_exam_booking_title">
						...
						<a href="{{ url('exam-booking-gcse') }}" class="btn_style btn_style3">Book Your Exam Now <span><img src="{{ asset('frontend/updatedesign') }}/assets/images/home/arrow-right.png" alt=""></span></a>
					</div>
				</div>
			</div>
		</div>
