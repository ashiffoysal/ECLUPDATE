...
@section('title', 'IGCSE Exams | Book Your IGCSE Exam in London | Exam Centre London')
@section('meta_description', 'Secure your place for IGCSE exams at Exam Centre London. We offer a wide range of subjects, including Maths, English, Science, and more. Convenient locations in East London. Book now!')
@section('content')
			...
			<div class="col-md-12">
				<div class="sub_menu">
					<ul>
						...
						<li><a href="{{ url('/exam-booking-igcse') }}">IGCSE Exam</a></li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="col-md-12">
				<div class="a_level_exams">
					<div class="section_title high_standard_title">
						<b>IGCSE Exam</b>
						<h2>Comprehensive <span>IGCSE Examination</span> and <span>Tuition Services</span></h2>
						<p>We offer tailored support for learners accessing the following forms of IGCSE examinations: IGCSE | International GCSE.

							If you’re looking to complete IGCSE assessment exam, whether for the first time, or as a resit to improve your grade, you’re in the right place. Exam Centre London is a leading Private IGCSE Exam Centre in London. Specialising in GCSE Maths, IGCSE Maths and International GCSE Maths for private candidates of all ages, we also offer a diverse range of other GCSE subject options.</p>
						<a href="{{ url('exam-booking-igcse') }}" class="btn_style">Book Your Exam Now <span><img src="{{ asset('frontend/updatedesign') }}/assets/images/home/arrow-right.png" alt=""></span></a>
					</div>
					<div class="contact_us a_level_exams_subjects">
						...
						<div class="contact_us_right a_level_exams_right">
							<div class="a_level_exams_right_title">
								...
								<p>We offer a wealth of different IGCSE options and are always happy to consider offering a subject of your choice if not listed below. Please get in touch to chat through your requirements and we’ll be happy to help.</p>
							</div>
							<div class="a_level_exams_right_contents">
								<ul>
									...
									<li><img src="{{ asset('frontend/updatedesign') }}/assets/images/home/square2.png" alt="">Science (Dual Award)</li>
									<li><img src="{{ asset('frontend/updatedesign') }}/assets/images/home/square2.png" alt="">English Literature</li>
									<li><img src="{{ asset('frontend/updatedesign') }}/assets/images/home/square2.png" alt="">English Language</li>
			...
			<div class="col-md-12">
				<div class="a_lavel_exam_bodies">
					...
					<div class="exam_board_title a_lavel_exam_bodies_title">
						<h3>IGCSE Exam Bodies</h3>
						<p>We work in partnership with a range of Awarding Bodies (often referred to as Exam Bodies). We offer GCSE with the following Awarding Bodies:</p>
					</div>
					...
					<div class="a_lavel_exam_bodies_calender">
						...
						<div class="a_lavel_exam_bodies_calender_contents">
							...
							<p>We offer IGCSE(Only Edexcel,CIE) Re-Sit Examinations in November. This is a popular option for School and College Leavers who wish to improve their grade(s). <br>Please contact us on 0208 616 25 26 for more information.</p>
			...
			<div class="col-md-12">
				<div class="a_lavel_exam_booking">
					<div class="a_lavel_exam_booking_title">
						...
						<a href="{{ url('exam-booking-igcse') }}" class="btn_style btn_style3">Book Your Exam Now <span><img src="{{ asset('frontend/updatedesign') }}/assets/images/home/arrow-right.png" alt=""></span></a>
					</div>
				</div>
			</div>
		</div>
