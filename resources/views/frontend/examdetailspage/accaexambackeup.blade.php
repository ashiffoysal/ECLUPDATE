                ...
                <div class="card" style="border-radius:55px">
                  ...
                  <div class="card-body">
                    ...
                    <div class="stepper stepper-links d-flex flex-column" id="kt_create_account_stepper">
                      ...
                      <!--end::Nav-->
                      <!--begin::Form-->
                      <form class="mx-auto mw-1000px w-100 pt-15 pb-10" novalidate="novalidate" id="kt_create_account_form" action="{{ url('/exam-booking-acca') }}" method="post">
                          ...
                          <div class="w-100">
                            <div class="fv-row">
                              ...
                              <div class="row">
                                  ...
                                  <!--end::Label-->
                                  <!--begin::Input-->
                                  <input type="text" class="form-control form-control-lg form-control-solid" name="acca_registration" placeholder="Please Enter ACCA Registration Number"/>
                                  <!--end::Input-->
                                </div>
                                <!--begin::Col-->
                                <div class="col-lg-6">
                                ...
                                <div class="col-md-12" style="margin-bottom:8px">
                                 ...
                                 <div class="col-md-3">
                                  ...
                                  <select name="type[]" id="type_0"  class="form-select form-select-lg form-select-solid type">
                                    ...
                                    <option value="Entry Level 1">ACCA Qalification</option>
                                    <option value="Entry Level 2">Foundation in Accountancy</option>
