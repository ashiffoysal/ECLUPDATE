...
@section('title', 'Book AS-Level Exams & Tuition in London | Flexible & Trusted Centre')
@section('meta_description', 'Register for AS-Level exams and tuition in London with Exam Centre London. Enjoy flexible scheduling, expert support, and quality education. Book your spot today!')
@section('content')
			...
			<div class="col-md-12">
				<div class="sub_menu">
					<ul>
						...
						<li><a href="{{ url('/as-level-exams') }}">AS Level Exam</a></li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="col-md-12">
				<div class="a_level_exams">
					<div class="section_title high_standard_title">
						<b>AS Level Exam</b>
						<h2>Comprehensive <span>As-Level Examination</span> and <span>Tuition Services</span></h2>
						<p>Thousands of home learners, distance learners, and independent candidates across London and Essex trust us for their As-Level exams. Our experienced tutors provide tailored tuition, exam preparation, and affordable assessments to meet your needs.</p>
						<a href="{{ url('exam-booking-aslevel') }}" class="btn_style">Book Your Exam Now <span><img src="{{ asset('frontend/updatedesign') }}/assets/images/home/arrow-right.png" alt=""></span></a>
					</div>
					<div class="contact_us a_level_exams_subjects">
						...
						<div class="contact_us_right a_level_exams_right">
							<div class="a_level_exams_right_title">
								<h3>AS LEVEL SUBJECTS</h3>
								<p>We offer a wealth of different AS-Level options and are always happy to consider offering a subject of your choice if not listed below. Please get in touch to chat through your requirements and we’ll be happy to help.</p>
							</div>
			...
			<div class="col-md-12">
				<div class="a_lavel_exam_bodies">
					...
					<div class="exam_board_title a_lavel_exam_bodies_title">
						<h3>AS Level Exam Bodies</h3>
						<p>We work in partnership with a range of Awarding Bodies (often referred to as Exam Bodies). We offer AS-Levels with the following Awarding Bodies:</p>
					</div>
					...
					<div class="a_lavel_exam_bodies_calender">
						...
						<div class="a_lavel_exam_bodies_calender_contents">
							...
							<p>We offer AS-Level(Only CIE) Re-Sit Examinations in November. This is a popular option for School and College Leavers who wish to improve their grade(s). <br>Please contact us on 0208 616 25 26 for more information.</p>
			...
			<div class="col-md-12">
				<div class="a_lavel_exam_booking">
					<div class="a_lavel_exam_booking_title">
						...
						<a href="{{ url('exam-booking-aslevel') }}" class="btn_style btn_style3">Book Your Exam Now <span><img src="{{ asset('frontend/updatedesign') }}/assets/images/home/arrow-right.png" alt=""></span></a>
					</div>
				</div>
			</div>
		</div>
