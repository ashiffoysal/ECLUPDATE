...
class ACCAExamBookingController extends Controller
{
  public function __construct()
    ...
    public function exambookingacca(){
        ...
        $subjects =Subject::where('exam_type','ACCA')->where('is_deleted',0)->get();
        return view('frontend.exambooking.accaexam',compact('subjects','bookingId'));
    }
