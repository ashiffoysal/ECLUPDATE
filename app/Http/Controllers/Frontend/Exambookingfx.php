...
{   public function __construct()
    ...
    public function exambookingattsubmit(Request $request){
      ...
      if ($request->hasFile('fileUpload')) {
            ...
            if ($insert) {
                    ...
                    //     });
                        // $details = [
                        //     'title' => 'Welcome to ECL',
                        //     'body' => 'This is the email body.',
                        //     'files' => $pdf
                        // ];
         
                        //  $sendmail=Mail::to($data->email)->send(new CandidateInvoiceMail($data));
    ...
    public function exambookinggcse(){
        ...
        $allsub=Subject::where('exam_type','GCSE')->where('exam_board','Edexcel')->where('is_deleted',0)->where('november_availability',1)->get();
        ...
        $allexamboard=['Edexcel','OCR','AQA','Cambridge CIE','WJEC'];
...
// a level
    public function exambookingalevel(){
        ...
        $allsub=Subject::where('exam_type','A Level')->where('exam_board','Cambridge CIE')->where('is_deleted',0)->where('november_cie_availability',1)->get();
        $maindata=ExamRequest::where('user_id',Auth::user()->id)->where('main_exam_type','A Level')->where('is_completed_from',0)->first();
        $allseries=Examessuedate::where('is_alevel',1)->where('is_active',1)->where('is_deleted',0)->get();


        $allexamboard=['Cambridge CIE','OCR','Edexcel','AQA','WJEC'];




        return view('frontend.exambooking.alevel',compact('allsub','maindata','allseries','allexamboard'));
    }
    ...
    public function exambookingigcse(){
        ...
        $allsub=Subject::where('exam_type','IGCSE')->where('exam_board','Edexcel')->where('is_deleted',0)->where('november_availability',1)->get();
        $maindata=ExamRequest::where('user_id',Auth::user()->id)->where('main_exam_type','IGCSE')->where('is_completed_from',0)->first();
        $allseries=Examessuedate::where('is_igcse',1)->where('is_active',1)->where('is_deleted',0)->get();
        ...
        return view('frontend.exambooking.igcse',compact('allsub','maindata','allseries','allexamboard'));
 ...
 if ($request->hasFile('fileUpload')) {
    ...
    public function photouploads(Request $request){
      ...
      public function exambookingaslevel(){
         ...
         $allsub=Subject::where('exam_type','AS Level')->where('exam_board','Cambridge CIE')->where('is_deleted',0)->where('november_cie_availability',1)->get();
         $maindata=ExamRequest::where('user_id',Auth::user()->id)->where('main_exam_type','AS Level')->where('is_completed_from',0)->first();
  
        $allseries=Examessuedate::where('is_deleted',0)->where('is_active',1)->where('is_aslevel',1)->get();
        ...
        return view('frontend.exambooking.aslevel',compact('allsub','maindata','allseries','allexamboard'));
