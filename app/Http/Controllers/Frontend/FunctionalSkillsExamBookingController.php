...
use PDF;
use DB;
class FunctionalSkillsExamBookingController extends Controller
{
    ...
    public function exambookingfuctionalskills(){
        ...
        $subjects =Subject::where('exam_type','Functional Skills')->where('is_deleted',0)->get();
        ...
        return view('frontend.exambooking.fuctionalskills',compact('subjects','maindata','allbranch','bookingId'));
    }
    ...
    //    return $request;
        ...
        if ($request->subject !=null && is_array($request->subject)) {
